...
- Descriptions must apply the transcript-derived voice method in `docs/editorial-guide-population-reference.md`: concrete observation, human stakes, fact-backed contradiction, clear judgment, and practical accuracy without copying a host persona, cadence, or signature phrasing.

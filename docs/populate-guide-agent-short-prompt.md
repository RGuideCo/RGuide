...
5. Apply the hard quality gates before writing:
   ...
   - every stop description must use the transcript-derived voice method in the editorial reference: concrete observation, human stakes, fact-backed contradiction, clear judgment, and practical accuracy, without copying a host persona or cadence;

...
const images = {
  ...
  vesuvio: commons("Vesuvio Cafe, San Francisco 2023-07-20.jpg"),
  hotelUtah: "https://hotelutah.com/wp-content/uploads/2022/06/Bar_lores-copy.jpg",
  mobyDick: commons("Moby Dick bar, San Francisco.jpg"),
  kilowatt: "https://images.squarespace-cdn.com/content/v1/63db2d061a225958e4bc286b/1723751489456-V3OWFQ631H3VXHCLTS7L/IMG_9829.jpg",
  fiveHundredClub: "https://s.hdnux.com/photos/01/66/31/77/31039450/3/rawImage.jpg",
  benders: "https://images.squarespace-cdn.com/content/v1/602dbd1b0b8c3e5483f1410a/1613611813624-VDD3SAH2A759QQQNE10I/BAR.jpg",
  auntCharlies: "https://s.hdnux.com/photos/01/44/46/14/26370858/3/rawImage.jpg",
...
const hours = {
  ...
  kilowatt: { mon: "5:00 PM-2:00 AM", tue: "5:00 PM-2:00 AM", wed: "5:00 PM-2:00 AM", thu: "5:00 PM-2:00 AM", fri: "5:00 PM-2:00 AM", sat: "1:00 PM-2:00 AM", sun: "1:00 PM-2:00 AM" },
  fiveHundredClub: { mon: "12:00 PM-2:00 AM", tue: "12:00 PM-2:00 AM", wed: "12:00 PM-2:00 AM", thu: "12:00 PM-2:00 AM", fri: "12:00 PM-2:00 AM", sat: "10:00 AM-2:00 AM", sun: "10:00 AM-2:00 AM" },
  benders: { mon: "Closed", tue: "2:00 PM-2:00 AM", wed: "2:00 PM-2:00 AM", thu: "2:00 PM-2:00 AM", fri: "2:00 PM-2:00 AM", sat: "2:00 PM-2:00 AM", sun: "2:00 PM-2:00 AM" },
  auntCharlies: { mon: "12:00 PM-10:30 PM", tue: "12:00 PM-10:30 PM", wed: "12:00 PM-10:30 PM", thu: "12:00 PM-10:30 PM", fri: "12:00 PM-11:45 PM", sat: "12:00 PM-11:45 PM", sun: "12:00 PM-11:30 PM" },
...
const casualBarStops = [
  ...
  stop({ id: "sf-dive-hotel-utah", name: "Hotel Utah Saloon", coordinates: [37.779525, -122.398354], description: "Hotel Utah Saloon is a 1908 SoMa bar with a mahogany room, bar food, and a small stage that moves through open mic, bluegrass, punk, rock, soul, and touring independent acts. The drinks stay straightforward; the official calendar supplies the night's reason to be there.", officialUrl: "https://hotelutah.com/", photo: images.hotelUtah, hours: { default: "Daily 11:00-00:00; the bar stays open later on show nights, with weekday shows commonly at 19:00 and weekend shows at 20:00 per the official calendar." }, price: "$", priceSource: "Official venue site and calendar", venueKind: "nightlife", nightlifeType: "live_music_venue", musicGenres: ["rock", "punk", "bluegrass", "soul"], attributeTags: ["dive_bars", "live_music", "historic", "bar_food"], editorialUrls: ["https://hotelutah.com/", "https://sf.eater.com/maps/best-dive-bars-san-francisco"] }),
  ...
  stop({ id: "sf-dive-kilowatt", name: "Kilowatt", coordinates: [37.764929, -122.423763], description: "Kilowatt is a Mission firehouse turned rock bar with a working stage, punk history, weekly live shows, DJ nights, darts, pool, and a long red room that still behaves like a neighborhood local.", officialUrl: "https://kilowattbar.com/", photo: images.kilowatt, hours: hours.kilowatt, price: "$$", priceSource: "Official venue site", venueKind: "nightlife", nightlifeType: "live_music_venue", musicGenres: ["punk", "rock", "indie"], attributeTags: ["dive_bars", "live_music", "games", "mission"], editorialUrls: ["https://sf.eater.com/maps/best-dive-bars-san-francisco", "https://www.restaurantji.com/ca/san-francisco/kilowatt-bar-/"] }),
  stop({ id: "sf-dive-500-club", name: "500 Club", coordinates: [37.763385, -122.424234], description: "The 500 Club has held its Guerrero Street corner since 1953 with red neon, a double-sided bar, a jukebox, a photo booth, and strong uncomplicated drinks. Its old 6:00 AM sign now marks history rather than the opening time.", officialUrl: "https://www.facebook.com/500ClubSF/", mapQuery: "500 Club 500 Guerrero Street San Francisco", photo: images.fiveHundredClub, hours: hours.fiveHundredClub, price: "$", priceSource: "Apple Maps / current local reporting", venueKind: "nightlife", nightlifeType: "dive_bar", musicGenres: ["rock", "country", "jukebox"], attributeTags: ["dive_bars", "historic", "cheap_drinks", "photo_booth"], editorialUrls: ["https://www.sfgate.com/sf-culture/article/dive-bar-500-club-22249427.php", "https://sf.eater.com/maps/best-dive-bars-san-francisco"] }),
  stop({ id: "sf-dive-benders", name: "Bender's Bar & Grill", coordinates: [37.759272, -122.417251], description: "Bender's is a South Van Ness punk bar with cluttered walls, draft beer, a full liquor shelf, pinball, a patio, and a kitchen serving burgers, fried food, and the bar's enduring tater tots.", officialUrl: "https://bendersbar.com/home", photo: images.benders, hours: hours.benders, price: "$", priceSource: "Official venue site", venueKind: "nightlife", nightlifeType: "dive_bar", musicGenres: ["punk", "metal", "rock"], attributeTags: ["dive_bars", "bar_food", "games", "patio"], editorialUrls: ["https://sf.eater.com/maps/best-dive-bars-san-francisco", "https://sf.eater.com/venue/17257/bender-s-bar-grill"] }),
  stop({ id: "sf-dive-aunt-charlies", name: "Aunt Charlie's Lounge", coordinates: [37.783564, -122.410056], description: "Aunt Charlie's is the Tenderloin's last queer bar, a cash-only neighborhood dive where inexpensive drinks share a tiny room with the Hot Boxxx Girls drag show, dance parties, and decades of community history.", officialUrl: "https://www.auntcharlieslounge.com/", photo: images.auntCharlies, hours: hours.auntCharlies, price: "$", priceSource: "Official venue site", venueKind: "nightlife", nightlifeType: "dive_bar", musicGenres: ["pop", "disco", "dance"], attributeTags: ["dive_bars", "queer_friendly", "drag", "cash_only"], editorialUrls: ["https://www.sfgate.com/sf-culture/article/aunt-charlies-drag-dive-bar-19841418.php", "https://sf.eater.com/maps/best-dive-bars-san-francisco"] }),
];
...
const sources = {
  ...
  casualBars: [...editorial.casualBars, ...casualBarStops.map((item) => source(`${item.name} official/current-status`, item.officialUrl ?? maps(item.name)))],
...
export const sanFranciscoGuides: MapList[] = [
  ...
  guide("Nightlife", "list-sf-dive-bars-casual-pubs", "sf-best-dive-bars-casual-pubs", "best-dive-bars", "Historic Dives & Neighborhood Bars", "San Francisco's dive-bar history survives in North Beach relics, Mission punk rooms, Chinatown neon, Castro and Tenderloin queer bars, and neighborhood locals with jukeboxes, pool tables, cheap drinks, and regulars.", casualBarStops, sources.casualBars, "Best Dive Bars in San Francisco", "Ten source-backed San Francisco dive bars, from Specs', Li Po, and Zeitgeist to Kilowatt, 500 Club, Bender's, and Aunt Charlie's."),

...
const images = {
  ...
  boweryGrand: "https://www.bowerygrandhotel.com/wp-content/uploads/2021/07/bowery-grand-hotel-nyc.jpg",
  americanDream: "https://www.americandreamhostel.com/wp-content/uploads/2020/03/american-dream-hostel-room.jpg",
  jazzPark: "https://www.jazzhostels.com/wp-content/uploads/2018/10/jazz-on-the-park-hostel.jpg",
...
const hostelStops = [
  ...
  stop({ id: "nyc-hostel-bowery-grand", name: "Bowery Grand Hotel", coordinates: [40.718939, -73.994845], description: "Bowery Grand Hotel is the ultra-budget Chinatown/Lower East Side option where the appeal is location and price, not comfort. It should be booked only by travelers who have read recent room details carefully and understand the tradeoff; private and shared-style budget rooms vary.", officialUrl: "https://www.bowerygrandhotel.com/", bookingUrl: "https://www.bowerygrandhotel.com/", photo: images.boweryGrand, hours: "Property operates daily; room types and check-in policies should be verified before booking.", price: "$", priceSource: "Official booking site / Booking.com", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "central", "chinatown", "private_rooms", "no_frills"], editorialUrls: ["https://www.booking.com/hostels/city/us/new-york.html", "https://www.google.com/travel/hotels/New%20York%20City?q=Bowery%20Grand%20Hotel"] }),
  ...
  stop({ id: "nyc-hostel-jazz-park", name: "Jazz on the Park Hostel", coordinates: [40.800389, -73.960724], description: "Jazz on the Park is an uptown hostel pick near Central Park and the B/C subway, with dorm-style budget appeal and a more student-traveler feel. It is best for travelers who want park access and can accept older facilities; check current reviews and room types before booking.", officialUrl: "https://www.jazzhostels.com/jazz-on-the-park/", bookingUrl: "https://www.jazzhostels.com/jazz-on-the-park/", photo: images.jazzPark, hours: "Hostel operates daily; dorm and private-room availability should be verified before booking.", price: "$", priceSource: "Official booking site / Hostelworld", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "dorms", "social", "central_park", "uptown"], editorialUrls: ["https://www.hostelworld.com/hostels/p/2292/jazz-on-the-park-hostel/", "https://www.booking.com/hostels/city/us/new-york.html"] }),
];

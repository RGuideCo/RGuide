...
madridCitywideGuides.push(buildNatureGuide({
  city: "Madrid", country: "Spain", continent: "Europe",
  id: "list-madrid-citywide-nature", slug: "madrid-best-parks-and-nature-citywide", seoSlug: "best-parks",
  seoTitle: "Best Parks and Nature in Madrid", seoDescription: "Madrid nature guide to Retiro, Casa de Campo, river paths, historic gardens, almond blossom, viewpoints, and El Pardo woodland.",
  title: "Royal Shade, River Paths, and Dry-Forest Horizons",
  description: "Madrid’s outdoor geography runs from formal central gardens to immense former hunting ground, river greenways, almond groves, and protected oak woodland at the city’s edge. Heat, seasonal gates, bloom timing, and long distances reward early starts and selective routes.",
  createdAt: "2026-07-29T00:00:00.000Z", checkedAt: "2026-08-04",
  sources: [
    { name: "Top organic result: Madrid tourism parks and gardens", url: "https://www.esmadrid.com/en/parks-and-gardens-madrid" },
    { name: "Madrid City Council parks", url: "https://www.madrid.es/portales/munimadrid/en/Inicio/Environment/Parks-and-gardens/" },
    { name: "Community of Madrid natural areas", url: "https://www.comunidad.madrid/en/servicios/urbanismo-medio-ambiente/espacios-naturales-protegidos" },
    { name: "Google Maps - Madrid parks and nature", url: "https://www.google.com/maps/search/best+parks+and+nature+Madrid" },
  ],
  stops: [
    { id: "madrid-nature-retiro", name: "El Retiro Park", coordinates: [40.4153, -3.6845], description: "Retiro mixes plane-tree avenues, lawns, rose gardens, monuments, exhibition halls, and a boating lake inside Madrid’s central UNESCO landscape. Weekend crowds are intense, but side paths and early mornings still reveal its serious garden structure.", hours: { default: "Daily: Apr–Sep 6:00 AM–midnight; Oct–Mar 6:00 AM–10:00 PM." }, officialUrl: "https://www.esmadrid.com/en/tourist-information/parque-del-retiro", subcategory: "historic_park", attributeTags: ["park", "lake", "garden", "central", "unesco"] },
    { id: "madrid-nature-casa-campo", name: "Casa de Campo", coordinates: [40.424, -3.763], description: "Casa de Campo covers dry woodland, reservoir shore, cycling roads, trails, and old royal hunting terrain west of the palace. Its enormous scale and limited shade make route selection, water, and public-transport exits more important than sightseeing ambition.", hours: { default: "Open 24 hours daily." }, officialUrl: "https://www.esmadrid.com/en/tourist-information/casa-de-campo", subcategory: "urban_forest", attributeTags: ["forest", "cycling", "hiking", "lake", "free_entry"] },
    { id: "madrid-nature-rio", name: "Madrid Río", coordinates: [40.4083, -3.724], description: "Madrid Río follows the Manzanares through planted parks, playgrounds, bridges, cycling paths, and restored river edges south and west of the center. The linear route is flat and practical, though exposed stretches become severe in summer heat.", hours: { default: "Open 24 hours daily." }, officialUrl: "https://www.esmadrid.com/en/tourist-information/madrid-rio-park", subcategory: "river_greenway", attributeTags: ["river", "cycling", "walking", "family_friendly", "accessible"] },
    { id: "madrid-nature-botanical", name: "Royal Botanical Garden", coordinates: [40.4111, -3.6914], description: "Madrid’s Royal Botanical Garden arranges historic scientific collections, Mediterranean plants, old trees, greenhouses, and seasonal beds beside the Prado. It is compact enough for close looking, with heat and temporary research closures affecting individual sections.", hours: { default: "Daily from 10:00 AM: Jan–Feb and Nov–Dec until 5:30 PM; Mar and Oct until 6:30 PM; Apr and Sep until 7:30 PM; May–Aug until 8:30 PM. Closed Dec 25 and Jan 1." }, officialUrl: "https://rjb.csic.es/", subcategory: "botanical_garden", attributeTags: ["garden", "plants", "historic", "ticketed", "central"] },
    { id: "madrid-nature-capricho", name: "El Capricho Park", coordinates: [40.4567, -3.5989], description: "El Capricho preserves an eighteenth-century estate of romantic woodland, formal gardens, water features, follies, and a Civil War bunker. Limited opening days keep it calmer than Retiro, but also make spontaneous visits unreliable.", hours: { default: "Sat, Sun, and public holidays only: Apr–Sep 9:00 AM–9:00 PM; Oct–Mar 9:00 AM–6:30 PM." }, officialUrl: "https://www.esmadrid.com/en/tourist-information/capricho-park", subcategory: "historic_garden", attributeTags: ["garden", "historic", "quiet", "free_entry", "limited_hours"] },
    { id: "madrid-nature-juan-carlos", name: "Juan Carlos I Park", coordinates: [40.4615, -3.608], description: "Juan Carlos I Park combines olive groves, lakes, public sculpture, cycling loops, and broad open ground near IFEMA. The landscape is modern and spacious rather than intimate, with bicycle rental and exposed weather shaping the visit.", hours: { default: "Jun–Sep daily 7:00 AM–1:00 AM. Oct–May Sun–Thu 7:00 AM–11:00 PM and Fri–Sat 7:00 AM–midnight." }, officialUrl: "https://www.esmadrid.com/en/tourist-information/juan-carlos-i-park", subcategory: "modern_landscape_park", attributeTags: ["park", "cycling", "sculpture", "lake", "family_friendly"] },
    { id: "madrid-nature-dehesa", name: "Dehesa de la Villa", coordinates: [40.457, -3.72], description: "Dehesa de la Villa keeps remnant pine and oak woodland, sandy paths, bird habitat, and western views in Madrid’s northwest. It feels less designed than the central parks, with running and walking routes used heavily by nearby residents.", hours: { default: "Open 24 hours daily." }, officialUrl: "https://www.madrid.es/portales/munimadrid/en/Inicio/Environment/Parks-and-gardens/", subcategory: "urban_woodland", attributeTags: ["forest", "walking", "birdwatching", "viewpoint", "free_entry"] },
    { id: "madrid-nature-tio-pio", name: "Cerro del Tío Pío", coordinates: [40.395, -3.653], description: "Cerro del Tío Pío forms a series of grassy hills above Vallecas with a wide west-facing view over Madrid’s skyline and distant sierra. The park is simple and exposed; sunset is the central event, bringing both beauty and crowds.", hours: { default: "Open 24 hours daily." }, officialUrl: "https://www.esmadrid.com/en/tourist-information/cerro-del-tio-pio", subcategory: "viewpoint_park", attributeTags: ["viewpoint", "sunset", "park", "free_entry", "local_favorite"] },
    { id: "madrid-nature-el-pardo", name: "Monte de El Pardo", coordinates: [40.521, -3.783], description: "Monte de El Pardo protects Mediterranean oak woodland, river habitat, and wildlife on Madrid’s northern edge, much of it within a restricted royal estate. Public routes occupy defined corridors, so access rules matter as much as trail choice.", hours: { default: "Official public-use access at San Francisco Meadow is daily 8:00 AM–7:00 PM; most of the royal woodland remains closed to public access." }, officialUrl: "https://www.patrimonionacional.es/en/visita/el-pardo-woodlands", subcategory: "protected_oak_forest", attributeTags: ["forest", "wildlife", "hiking", "river", "restricted_access"] },
    { id: "madrid-nature-quinta-molinos", name: "Quinta de los Molinos", coordinates: [40.4421, -3.625], description: "Quinta de los Molinos combines almond groves, olives, pines, formal estate remnants, and open lawns in Madrid’s east. February and March blossom creates intense demand; outside it, the park returns to a quieter neighborhood rhythm.", hours: { default: "Daily 6:30 AM–10:00 PM." }, officialUrl: "https://www.esmadrid.com/informacion-turistica/quinta-molinos", subcategory: "orchard_park", attributeTags: ["almond_blossom", "park", "seasonal", "free_entry", "family_friendly"] },
  ],
}));

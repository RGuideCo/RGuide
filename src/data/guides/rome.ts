...
const hotelStops = {
  ...
  testaccio: [
    ...
    { id: "testaccio-abitart", name: "Abitart Hotel", coordinates: [41.8756, 12.4819], description: "Abitart Hotel is the practical Ostiense/Testaccio base, useful for travelers who want train/metro access, food neighborhoods, and less historic-center pressure. The value is the sleep tradeoff: location, room style, price posture, and how easily the stay supports the surrounding route. Confirm the current room type, check-in details, and transit fit before booking.", price: "$$", priceSource: "Booking.com / Google Travel", photo: undefined },
  ...
  garbatella: [
    { id: "garbatella-hotel-caravel", name: "Hotel Caravel", coordinates: [41.8567, 12.4956], description: "Hotel Caravel is the practical Garbatella-adjacent base, best for travelers prioritizing value, transit, and southern Rome logistics over old-city romance. The value is the sleep tradeoff: location, room style, price posture, and how easily the stay supports the surrounding route. Confirm the current room type, check-in details, and transit fit before booking.", price: "$$", priceSource: "Booking.com / Google Travel", photo: undefined },
...
const hostelStops = {
  ...
  monti: [
    ...
    { id: "monti-hostel-generator", name: "Generator Rome", coordinates: [41.8967, 12.5065], description: "Generator Rome sits on the Esquilino edge, but it serves Monti travelers who want a design hostel with dorms and private rooms near Termini and the Colosseum corridor. The value is the sleep tradeoff: location, room style, price posture, and how easily the stay supports the surrounding route. Confirm the current room type, check-in details, and transit fit before booking.", price: "$", priceSource: "Hostelworld / Google Maps", photo: undefined },
  ],
  testaccio: [
    { id: "testaccio-hostel-borgo-ripa", name: "Borgo Ripa Urban Travel", coordinates: [41.8873, 12.4753], description: "Borgo Ripa is the closest credible hostel-style choice for Testaccio routes, especially for travelers who want Trastevere access at night and Testaccio food by foot or short transit. The value is the hostel tradeoff: dorm and private-room flexibility, common-space energy, price, and whether the location honestly serves the neighborhood route. Confirm current ratings, check-in rules, lockers, and late-arrival details before booking.", price: "$", priceSource: "Hostelworld / Google Maps", photo: undefined },
  ...
  prati: [
    { id: "prati-hostel-comics", name: "Comics Guesthouse", coordinates: [41.9116, 12.4663], description: "Comics Guesthouse is the most honest Prati hostel-style option, close to the Vatican side and useful for private/dorm travelers who want a quieter base than Termini. The value is the sleep tradeoff: location, room style, price posture, and how easily the stay supports the surrounding route. Confirm the current room type, check-in details, and transit fit before booking.", price: "$", priceSource: "Hostelworld / Google Maps", photo: undefined },
...
const neighborhoodFoodGuides = [
  ...
  neighborhoodGuide("Trastevere", "Food", "Restaurants", [
    ...
    { id: "trastevere-seu-pizza", name: "Seu Pizza Illuminati", coordinates: [41.8847, 12.4727], description: "Seu Pizza Illuminati brings destination pizza to the edge of Trastevere, useful when the neighborhood plan needs something more current than another pasta table. The value is the meal format and neighborhood fit: what to order, how formal the stop feels, and whether it solves lunch, dinner, coffee, or a snack break. Confirm current hours and booking pressure before relying on it as the route's main meal.", price: "$$", priceSource: "Eater / The Infatuation", photo: undefined },
  ...
  neighborhoodGuide("Celio", "Food", "Restaurants", [
    ...
    { id: "celio-isidoro", name: "Hostaria Isidoro", coordinates: [41.889, 12.4976], description: "Hostaria Isidoro is the more formal Celio trattoria option, useful when the route needs a seated dinner near the ancient core rather than a quick pizza or snack. The value is the meal format and neighborhood fit: what to order, how formal the stop feels, and whether it solves lunch, dinner, coffee, or a snack break. Confirm current hours and booking pressure before relying on it as the route's main meal.", price: "$$", priceSource: "Google Maps / Tripadvisor", photo: undefined },
...
const neighborhoodCultureGuides = [
  neighborhoodGuide("Centro Storico", "Culture", "Culture", [
    { id: "centro-pantheon", name: "Pantheon", coordinates: [41.8986, 12.4769], description: "The Pantheon is the essential Centro Storico stop because it explains Roman engineering, church continuity, and piazza life in one short visit. The experience gives the area more context than a surface-level walk, whether through architecture, collections, street history, or a quieter interior. Check current opening days and ticket needs, then place it where the route can slow down enough to absorb it.", photo: photos.pantheon },
  ...
  neighborhoodGuide("Monti", "Culture", "Culture", [
    ...
    { id: "monti-san-pietro-vincoli", name: "San Pietro in Vincoli", coordinates: [41.8932, 12.4922], description: "San Pietro in Vincoli earns a saved-map spot for Michelangelo's Moses and the way it hides major art on a quieter Monti slope. The value is its role in the route: it adds a concrete experience, a timing choice, and a reason to save the stop rather than wander past it. Check current hours and fit it into the nearby cluster instead of treating it as a standalone errand.", photo: "https://upload.wikimedia.org/wikipedia/commons/6/63/Michelangelo%27s_Moses.jpg" },
    { id: "monti-palazzo-esposizioni", name: "Palazzo delle Esposizioni", coordinates: [41.8992, 12.4902], description: "Palazzo delle Esposizioni gives Monti a contemporary exhibition counterweight to ancient and church-heavy routes. The experience gives the area more context than a surface-level walk, whether through architecture, collections, street history, or a quieter interior. Check current opening days and ticket needs, then place it where the route can slow down enough to absorb it.", photo: "https://upload.wikimedia.org/wikipedia/commons/f/f7/Palazzo_delle_Esposizioni_Rome.jpg" },
  ...
  neighborhoodGuide("Testaccio", "Culture", "Culture", [
    ...
    { id: "testaccio-porta-san-paolo", name: "Porta San Paolo", coordinates: [41.8766, 12.4803], description: "Porta San Paolo and the Pyramid edge give Testaccio an ancient-gate frame, useful before moving toward Ostiense or the cemetery. The value is its role in the route: it adds a concrete experience, a timing choice, and a reason to save the stop rather than wander past it. Check current hours and fit it into the nearby cluster instead of treating it as a standalone errand.", photo: "https://upload.wikimedia.org/wikipedia/commons/e/e6/Porta_San_Paolo_Rome.jpg" },
  ...
  neighborhoodGuide("Garbatella", "Culture", "Culture", [
    ...
    { id: "garbatella-teatro-palladium", name: "Teatro Palladium", coordinates: [41.8604, 12.4887], description: "Teatro Palladium is the neighborhood's performance anchor, useful for understanding Garbatella as a lived cultural district rather than a scenic detour. The experience gives the area more context than a surface-level walk, whether through architecture, collections, street history, or a quieter interior. Check current opening days and ticket needs, then place it where the route can slow down enough to absorb it.", photo: undefined },
  ...
  neighborhoodGuide("Celio", "Culture", "Culture", [
    { id: "celio-colosseum", name: "Colosseum", coordinates: [41.8902, 12.4922], description: "The Colosseum is Celio's unavoidable anchor, but it works best as part of a timed ancient-city block rather than a standalone photo stop. The experience gives the area more context than a surface-level walk, whether through architecture, collections, street history, or a quieter interior. Check current opening days and ticket needs, then place it where the route can slow down enough to absorb it.", photo: photos.colosseum },
...
const neighborhoodNightlifeGuides = [
  neighborhoodGuide("Centro Storico", "Nightlife", "Bars", [
    ...
    { id: "centro-salotto-42", name: "Salotto 42", coordinates: [41.899, 12.4791], description: "Salotto 42 gives the Pantheon area a stylish aperitivo/cocktail room that works before dinner or as a polished nightcap. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Time Out / Google Maps", photo: undefined },
  ...
  neighborhoodGuide("Monti", "Nightlife", "Bars", [
    { id: "monti-blackmarket", name: "Blackmarket Hall", coordinates: [41.8944, 12.4916], description: "Blackmarket Hall is Monti's late-room pick for cocktails, music, and a moodier alternative to open-air piazza drinking. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Time Out / Google Maps", photo: "https://www.blackmarkethall.com/blackmarkethall.png" },
    { id: "monti-ai-tre-scalini", name: "Ai Tre Scalini", coordinates: [41.8955, 12.4913], description: "Ai Tre Scalini is the wine-bar/trattoria bridge that makes Monti nights easy to start without committing to a full bar crawl. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Google Maps / local editorial guides", photo: undefined },
  ...
  neighborhoodGuide("Testaccio", "Nightlife", "Bars", [
    { id: "testaccio-tram-depot", name: "Tram Depot", coordinates: [41.8792, 12.4782], description: "Tram Depot is Testaccio's outdoor aperitivo and cocktail stop, especially useful in warm weather when the neighborhood needs a casual first drink. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Google Maps / local editorial guides", photo: undefined },
    { id: "testaccio-rec23", name: "Rec 23", coordinates: [41.8769, 12.4762], description: "Rec 23 gives Testaccio a flexible drinks-and-food room near the market, good for groups that want cocktails without leaving the district. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Google Maps", photo: undefined },
  ...
  neighborhoodGuide("Prati", "Nightlife", "Bars", [
    ...
    { id: "prati-chorus", name: "Chorus Café", coordinates: [41.9036, 12.4628], description: "Chorus Cafe gives Prati a polished cocktail room near the Vatican approach, better for a seated drink than a pub crawl. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$$", priceSource: "Time Out / Google Maps", photo: undefined },
    { id: "prati-sorpasso-bar", name: "Il Sorpasso", coordinates: [41.9075, 12.4597], description: "Il Sorpasso works as the wine-and-aperitivo pick, bridging Prati's restaurant scene with a relaxed first-drink plan. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Eater / Google Maps", photo: undefined },
  ...
  neighborhoodGuide("Celio", "Nightlife", "Bars", [
    ...
    { id: "celio-shamrock", name: "Shamrock Irish Pub Colosseum", coordinates: [41.8901, 12.4938], description: "Shamrock is the practical pub option near the Colosseum, best when a group wants beer, screens, and an easy meeting point. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Google Maps", photo: undefined },
    { id: "celio-propaganda-bar", name: "Caffè Propaganda", coordinates: [41.8894, 12.4951], description: "Caffe Propaganda is the polished Celio drink-and-dessert option, useful for a calmer nightcap after ancient-site days. The draw is the specific night use: what kind of crowd, drink format, and energy it adds to the neighborhood. Go when that mood fits the route, and confirm current hours or event programming before building the evening around it.", price: "$$", priceSource: "Time Out / Google Maps", photo: undefined },

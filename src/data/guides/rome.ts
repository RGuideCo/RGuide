...
const hostelStops = {
  ...
  monti: [
    ...
    { id: "monti-hostel-generator", name: "Generator Rome", coordinates: [41.8967, 12.5065], description: "Generator Rome sits on the Esquilino edge, so it is not the most intimate Monti pick, but it gives travelers a larger design-hostel setup with dorms and private rooms. Use it when Termini logistics, value, and a bigger hostel operation matter more than sleeping on a Monti side street.", price: "$", priceSource: "Hostelworld / Google Maps", photo: undefined },
  ],
  testaccio: [

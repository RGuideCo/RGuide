...
const neighborhoodFoodGuides = [
  ...
  ], "Vatican-Day Food With a Plan", "Prati keeps Vatican-area eating grounded through pizza slices, aperitivo, pantry shops, and trattoria dinners beyond museum cafeterias.", romeFoodSources),

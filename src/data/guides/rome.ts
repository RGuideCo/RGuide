...
const photoByName: Record<string, string> = {
  ...
  "Trattoria Da Cesare al Casaletto": commonsFile("Cacio_e_pepe.jpg"),
  ...
  "SantoPalato": commonsFile("Wine_glasses_on_a_table_.jpg"),
...
const citywideFood: StopSeed[] = [
  ...
  },
  {
    ...
    description: "Da Cesare al Casaletto earns the cross-town trip because it feels like a local Roman meal rather than a center-city trophy reservation. The draw is confident trattoria cooking, especially fritti, pastas, and a patio rhythm that rewards the tram ride out to Casaletto. Use it when you want one meal outside the obvious sightseeing grid and can build the timing around the journey.",
    price: "$$",
    priceSource: "Eater / The Infatuation",
    hours: {
...
const romeCoreGuides = [
  guide({
    ...
    description: "A citywide restaurant spine for Rome: a serious central reservation, a Trastevere trattoria, a Pantheon classic, modern Roman cooking, a cross-town local favorite, and a Testaccio institution. The value is the meal format and neighborhood fit: what to order, how formal the stop feels, and whether it solves a classic Roman dinner or a more deliberate food-led route. Confirm current hours and booking pressure before relying on any stop as the route's main meal.",

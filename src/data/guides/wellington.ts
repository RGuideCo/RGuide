...
export const wellingtonCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    "Wellington Pubs, Taprooms, and Easy Live-Music Bars",
    "Wellington's low-ceremony night runs through brewery taprooms, deep beer lists, a Welsh oddity, outdoor live music, neighbourhood taverns, and rooms where the person pouring can usually explain the beer.",
    pubStops,
    sourcesFor(
      pubStops,
      source("WellingtonNZ craft-beer guide", editorial.pubs),
    ),
    "Best Pubs and Casual Bars in Wellington for Beer and Live Music",
    "Ten current Wellington pubs and casual bars spanning Welsh Dragon, Rogue & Vagabond, Golding's, Parrotdog, Mean Doses, Heyday, Sprig + Fern, Malthouse, Garage Project, and Fork & Brewer.",
  ),
  guide(
    "Nightlife",

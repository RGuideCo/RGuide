...
const neighborhoodGuides: GuideSpec[] = [
  ...
  hostelGuide("soho-hostels", "soho-hostels", "Best Hostels near Soho, London", "Central hostel bases that put budget travelers close to the British Museum, Soho, Covent Garden, and late-night transit.", "Soho", ["astorMuseum", "generator", "clink261", "smartRussell"], "West End Dorms Near Soho Nights"),
  hostelGuide("covent-garden-hostels", "covent-garden-hostels", "Best Hostels near Covent Garden, London", "Budget dorm bases for travelers who want theatre, museums, and the West End without long night journeys.", "Covent Garden", ["astorMuseum", "generator", "clink261", "smartRussell"], "Theatreland Dorms and Museum Walks"),
  hostelGuide("shoreditch-hostels", "shoreditch-hostels", "Best Hostels near Shoreditch, London", "East-side and central social bases for backpackers who want bars, markets, live music, and quick links into the City.", "Shoreditch", ["wombats", "stChristopherBorough", "generator", "clink261"], "East-Side Hostels for Markets and Nights"),
  hostelGuide("notting-hill-hostels", "notting-hill-hostels", "Best Hostels near Notting Hill, London", "West and central London hostel bases for Portobello days, park access, and a quieter sleep than the party districts.", "Notting Hill", ["onefamNotting", "astorMuseum", "generator", "smartRussell"], "West London Beds Near Parks and Portobello"),
  hostelGuide("south-bank-hostels", "south-bank-hostels", "Best Hostels near South Bank, London", "Borough and central hostel bases for travelers who want markets, Tate Modern, river walks, and station access.", "South Bank", ["stChristopherBorough", "wombats", "generator", "astorMuseum"], "Borough Beds for Markets and River Walks"),
  hostelGuide("camden-hostels", "camden-hostels", "Best Hostels in Camden, London", "Camden hostel and hybrid stays for budget travelers who want market days, Roundhouse shows, pub crawls, and Northern line access.", "Camden", ["stChristopherCamden", "smartCamden", "selinaCamden"], "Camden Dorms for Markets and Gigs"),
  hostelGuide("bloomsbury-hostels", "bloomsbury-hostels", "Best Hostels in Bloomsbury, London", "Bloomsbury and King's Cross hostels for British Museum access, central transit, dorm beds, and budget stays near the West End.", "Bloomsbury", ["generator", "astorMuseum", "clink261", "smartRussell"], "Bloomsbury Beds Between Museums and King's Cross"),

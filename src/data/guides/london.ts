...
const stops: Record<string, GuideStop> = {
  ...
  mildreds: stop("soho-food-mildreds", "Mildreds Soho", [51.5145, -0.1361], "Mildreds is an international vegetarian restaurant built around organic, seasonal produce, casual wine, and enough range for mixed Soho groups.", photo.restaurant, "$$"),
  ...
  hoppers: stop("soho-food-hoppers", "Hoppers Soho", [51.5133, -0.1365], "Hoppers brings Sri Lankan and South Indian food into the central London spice route, with hoppers, dosas, sambols, kari, and a room that works for a proper meal rather than a snack.", photo.restaurant, "$$"),
  fourSeasonsChinatown: stop("soho-food-four-seasons", "Four Seasons Chinatown", [51.5117, -0.1315], "Four Seasons Chinatown is a practical Cantonese roast-meat stop, useful when the guide needs Chinese food in the West End rather than another generic central table.", photo.restaurant, "$$"),
  ...
  smokingGoat: stop("shoreditch-food-smoking-goat", "Smoking Goat Shoreditch", [51.5238, -0.0787], "Smoking Goat is a cool, laid-back restaurant serving punchy dishes and drinks inspired by Bangkok's late-night canteens.", photo.restaurant, "$$"),
  ...
  manteca: stop("shoreditch-food-manteca", "Manteca", [51.5263, -0.0808], "Manteca is the Shoreditch pasta-and-butcher counter for hand-rolled pasta, house-cured meats, and a dinner that feels relaxed without being casual filler.", photo.restaurant, "$$"),
  ePellicci: stop("shoreditch-food-pellicci", "E. Pellicci", [51.5262, -0.0629], "E. Pellicci is a vintage Art Deco workers' cafe offering the full English breakfast and Italian classics since 1900.", photo.restaurant, "$"),
  gunpowder: stop("shoreditch-food-gunpowder", "Gunpowder Spitalfields", [51.5187, -0.0758], "Gunpowder brings modern Indian small plates to Spitalfields, useful when the spice route needs sharper Indian cooking than a nostalgia-only curry-house stop.", photo.restaurant, "$$"),
  ...
  theLedbury: stop("notting-food-ledbury", "The Ledbury", [51.5173, -0.2003], "The Ledbury pairs chef Brett Graham's innovative cooking with fine wines in a smart, modern setting, making it one of west London's true destination reservations.", photo.restaurant, "$$$"),
  ...
  gold: stop("notting-food-gold", "Gold", [51.5161, -0.2032], "Gold brings modern European sharing plates, wood-fired cooking, and a polished Portobello room that can turn a browsing day into dinner.", photo.restaurant, "$$$"),
  ...
  sketch: stop("mayfair-food-sketch", "Sketch", [51.5129, -0.1416], "Sketch is the iconic Mayfair restaurant complex for art-led rooms, afternoon tea, cocktails, and special-occasion dining that feels unmistakably London.", photo.restaurant, "$$$"),
  maru: stop("mayfair-food-maru", "Maru", [51.5106, -0.1449], "Maru is a small Japanese omakase counter in Mayfair, adding precision and East Asian range to a citywide food list that should not lean only British or European.", photo.restaurant, "$$$"),

  boroughMarket: stop("southbank-food-borough-market", "Borough Market", [51.5054, -0.0906], "Borough Market has around 1,000 years of history and remains London's most famous food market, with essential grazing from names like Kappacasein, Bread Ahead, Brindisa, and seafood counters around the arches.", photo.market, "$$"),
  padella: stop("southbank-food-padella", "Padella Borough", [51.5051, -0.0899], "Padella Borough is the housemade-pasta queue for pici, tagliarini, wine, and Italianate drinks beside the market.", photo.restaurant, "$$"),
  bratXclimpson: stop("southbank-food-brat-x-climpson", "BRAT x Climpson's Arch", [51.5059, -0.0921], "BRAT x Climpson's Arch is a working factory-style dining room with seasonal food cooked on wood-fired ovens and grill, plus cocktails and DJs.", photo.restaurant, "$$$"),
  wrightBrothers: stop("southbank-food-wright-brothers", "Wright Brothers Borough", [51.5052, -0.0911], "Wright Brothers is the Borough seafood and oyster stop, useful for shellfish, fish plates, and a proper counter meal beside the market rather than another walk-by snack.", photo.restaurant, "$$"),
  flatIronSquare: stop("southbank-food-flat-iron-square", "Flat Iron Square", [51.5056, -0.0961], "Flat Iron Square is a popular Bankside food, drink, and entertainment hub near London Bridge, with an open-air courtyard, indoor taproom, and rotating street-food vendors.", photo.market, "$$"),
  camdenMarket: stop("camden-food-market", "Camden Market", [51.5413, -0.1469], "Camden Market earns a food-market slot for canal-side grazing, global street-food traders, and casual counters that make it more useful as lunch than as a souvenir browse.", photo.market, "$$"),
  ...
  spitalfieldsMarket: stop("shoreditch-culture-spitalfields", "Old Spitalfields Market", [51.5197, -0.0755], "Old Spitalfields Market brings independent fashion designers, artisan makers, antique dealers, and popular street-food kitchens into a historic East End trading hall.", photo.market),
  brickLane: stop("shoreditch-culture-brick-lane", "Brick Lane", [51.5217, -0.0717], "Brick Lane is the East End corridor for curry houses, weekend markets, murals, vintage shops, and famous bagel counters like Beigel Bake and Beigel Shop.", photo.london),
  ...
  portobello: stop("notting-culture-portobello", "Portobello Road Market", [51.5156, -0.2033], "Portobello Road Market in Notting Hill is the world's largest antiques market, stretching nearly two miles with more than 1,000 stalls across antiques, vintage, food, and fashion.", photo.market),
  ...
  frenchHouse: stop("soho-bar-french-house", "The French House", [51.5127, -0.1326], "The French House is a historic Soho pub first, famous for half-pints, artists, theatre people, and a compact upstairs dining room rather than French fine dining.", photo.pub, "$$"),
  ...
  lambFlag: stop("covent-bar-lamb-flag", "The Lamb & Flag", [51.5114, -0.1259], "The Lamb & Flag is a traditional Georgian Covent Garden pub and former Charles Dickens haunt, with enough history and bustle to make it a strong pre-theatre pint or pub meal.", photo.pub, "$$"),
  ...
  theCow: stop("notting-bar-cow", "The Cow", [51.5206, -0.2001], "The Cow is a gastropub with a compact upstairs dining room for oysters, seafood, and seasonal British cooking.", photo.pub, "$$"),
  ...
  anchorBankside: stop("southbank-bar-anchor", "The Anchor Bankside", [51.5074, -0.0927], "The Anchor Bankside is a 1615 Thameside pub serving food in the bar and restaurant, with real ale and river views between Borough Market and Tate Modern.", photo.pub, "$$"),
  ...
  redLion: stop("westminster-bar-red-lion", "The Red Lion", [51.5019, -0.1262], "The Red Lion is a classic Westminster pub for ale, pies, and a proper central London lunch between Parliament, St James's, and theatre plans.", photo.pub, "$$"),
  masonsArms: stop("mayfair-bar-masons-arms", "The Mason's Arms", [51.5119, -0.1465], "The Mason's Arms gives Mayfair a traditional pub-food stop for roasts, pies, and pints when the route needs something more grounded than another polished restaurant.", photo.pub, "$$"),
  sherlockHolmesPub: stop("westminster-bar-sherlock-holmes", "The Sherlock Holmes Pub", [51.5073, -0.1245], "The Sherlock Holmes Pub is a central old-school pub for British comfort food, cask ale, and a tourist-friendly dining room that still fits the pub-meal brief.", photo.pub, "$$"),
  loreOfTheLand: stop("fitzrovia-bar-lore-of-the-land", "The Lore of the Land", [51.5223, -0.1415], "The Lore of the Land is a polished Fitzrovia pub for seasonal British cooking, roasts, and pints with enough dining pull to justify crossing town.", photo.pub, "$$$"),

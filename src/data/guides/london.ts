...
const poiPhotos: Record<string, string> = {
  ...
  "soho-culture-carnaby": "https://images.pexels.com/photos/30847170/pexels-photo-30847170/free-photo-of-carnaby-street-festive-lights-in-london.jpeg",
  ...
  "camden-bar-jazz-cafe": "https://thejazzcafe.com/wp-content/uploads/2021/08/jazz-restaurantcrop-minfinfin.jpg",
  ...
  "citywide-culture-kensington-palace": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Kensington_Palace_from_the_south.jpg/1280px-Kensington_Palace_from_the_south.jpg",
  "citywide-culture-harrods": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Harrods_at_night%2C_London_-_Nov_2012.jpg/1280px-Harrods_at_night%2C_London_-_Nov_2012.jpg",
  ...
  "fitzrovia-bar-lore-of-the-land": "https://gritchiepubs.com/wp-content/uploads/2023/08/321543314_1818764548482437_5990080219340714211_n.jpeg",
  ...
  "shoreditch-food-gunpowder": "https://gunpowderrestaurants.com/wp-content/uploads/2025/11/Copy-of-chicken-lolipop-1-scaled.webp",
  ...
  "hackney-food-cafe-cecilia": "https://cdn.sanity.io/images/jahfmphz/production/658e2bd0561dfd6cb04aa2df8eceb1e72d3b97f8-3750x2500.jpg?w=1200&h=800&auto=format",
...
const guideDescriptions: Record<string, string> = {
  ...
  "citywide-dive-bars": [
    "The best low-key London nights are not all one mood. The French House and Bradley's keep Soho old-school, The Dublin Castle and Old Blue Last bring live-music pub history, Dalston Superstore adds queer late-night energy, and The Anchor puts the river in the background.",
    "This is now a wider London nightlife starter instead of pubs and late rooms mashed together.",
  ].join(" "),
  "citywide-culture": [
...
const neighborhoodGuides: GuideSpec[] = [
  ...
  hostelGuide("soho-hostels", "soho-hostels", "Best Hostels in and near Soho, London", "Central hostel bases for budget travelers who want Soho nightlife, Covent Garden, the British Museum, and late-night transit within easy reach.", "Soho", ["astorMuseum", "generator", "clink261", "smartRussell"], "Central Dorms for Soho Nights"),
  hostelGuide("covent-garden-hostels", "covent-garden-hostels", "Best Hostels near Covent Garden, London", "Budget dorm bases for travelers who want theatre, museums, and the West End without long night journeys.", "Covent Garden", ["astorMuseum", "generator", "clink261", "smartRussell"], "Dorms Near Theatreland and Museum Walks"),
  hostelGuide("shoreditch-hostels", "shoreditch-hostels", "Best Hostels near Shoreditch, London", "East-side and central social bases for backpackers who want bars, markets, live music, and quick links into the City.", "Shoreditch", ["wombats", "stChristopherBorough", "generator", "clink261"], "East-Side Hostels and King's Cross Backups"),
...
const citywideGuides: GuideSpec[] = [
  ...
  diveBarGuide("citywide-dive-bars", "best-dive-bars-citywide", "Best Pubs and Dive Bars in London", "Best pubs, low-key bars, queer rooms, and live-music pub history across London.", undefined, ["frenchHouse", "bradleys", "dublinCastle", "oldBlueLast", "dalstonSuperstore", "anchorBankside"], "Old Pubs, Queer Rooms, and Live-Music Bars"),

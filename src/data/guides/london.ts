...
const citywideGuides: GuideSpec[] = [
  ...
  foodGuide("citywide-pub-dining", "best-pub-food-citywide", "Best Pub Food in London", "Best pub lunches, pub dinners, oyster pints, roasts, pies, and old London cafe meals across the city.", undefined, ["loreOfTheLand", "ePellicci", "lambFlag", "theCow", "anchorBankside", "redLion", "masonsArms", "sherlockHolmesPub", "frenchHouse"], "Pub Breakfasts, Lunches, and Proper Dinners"),
  ...
  foodGuide("citywide-south-asian", "best-asian-spice-routes-citywide", "Best Asian Restaurants and Spice Routes in London", "Best Asian and spice-led restaurants in London, from low-cost roti queues and Sri Lankan rooms to Thai, Chinese, and modern Indian destination counters.", undefined, ["rotiKingEuston", "dishoomCovent", "hoppers", "gunpowder", "kiln", "smokingGoat", "churchillArms", "fourSeasonsChinatown"], "Spice Routes Across London"),
  foodGuide("citywide-vegetarian", "best-vegetarian-vegan-food-citywide", "Best Vegetarian and Vegan Food in London", "Best vegetarian and vegan restaurants in London, from formal plant-based tasting menus and generous Middle Eastern sharing tables to vegan Chinese, Soho staples, and Borough Market dinners.", undefined, ["gauthier", "mildreds", "bubala", "mallow", "tofuVegan", "tendril", "plates"], "Vegetarian and Plant-Based London"),
  popularBarGuide("citywide-popular-bars", "best-popular-bars-citywide", "Best Bars in London", "Best bars in London, from Soho cocktails and hotel classics to Shoreditch venues, west London rum rooms, and South Bank rooftops.", undefined, ["swift", "americanBar", "happinessForgets", "trailerHappiness", "twelveKnot"], "Cocktail Rooms, Jazz, and Skyline Drinks"),
  popularBarGuide("citywide-dive-bars", "best-dive-bars-citywide", "Best LGBTQ+ Nightlife in London", "Best LGBTQ+ bars, cabaret rooms, queer clubs, and social spaces in London, from Soho and Charing Cross to Dalston.", undefined, ["heaven", "halfwayHeaven", "yardBar", "sheSoho", "dalstonSuperstore"], "LGBTQ+ Clubs, Cabaret Rooms, and Queer Bars"),
  ...
  cultureGuide("citywide-museums-galleries", "museums-and-galleries", "Best Museums and Galleries in London", "V&A, Tate Britain, National Portrait Gallery, Wallace Collection, Royal Academy, and Kensington Palace for London museum depth beyond the obvious first stops.", undefined, ["victoriaAlbert", "tateBritain", "nationalPortraitGallery", "wallaceCollection", "royalAcademy", "kensingtonPalace"], "Museums, Galleries, and Palace Rooms"),
  cultureGuide("citywide-shopping-culture", "shopping-streets-and-design-landmarks", "Best Shopping Streets and Design Landmarks in London", "Liberty, Harrods, Selfridges, Carnaby Street, Oxford Street, Brick Lane, and Portobello as London shopping culture and street identity.", undefined, ["liberty", "harrods", "selfridges", "carnabyStreet", "oxfordStreet", "brickLane", "portobello"], "Shopping Streets and Design Landmarks"),

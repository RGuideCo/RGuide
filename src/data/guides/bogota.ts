...
const casualBarStops: GuideStop[] = [
  ...
  nightlife({
    ...
    nightlifeType: "live_music", musicGenres: ["Latin alternative", "cumbia", "electronic"], attributeTags: ["live-music", "independent", "queer-friendly", "events"], price: "$$", hours: schedule.event,
  ...
  nightlife({
    ...
    nightlifeType: "live_music", musicGenres: ["experimental", "improvised", "jazz"], attributeTags: ["listening-room", "independent", "live-music", "intimate"], price: "$$", hours: schedule.event,
  ...
  nightlife({
    ...
    nightlifeType: "dance_bar", musicGenres: ["salsa", "Afro-Caribbean"], attributeTags: ["salsa", "dance-floor", "local-bar", "live-music"], price: "$$", hours: schedule.event,
  ...
  nightlife({
    ...
    nightlifeType: "brewpub", musicGenres: [], attributeTags: ["craft-beer", "casual", "groups", "pub-food"], price: "$$",
  ...
  nightlife({
    ...
    nightlifeType: "brewpub", musicGenres: ["varied live music"], attributeTags: ["craft-beer", "courtyard", "groups", "casual"], price: "$$",
...
const cultureStops: GuideStop[] = [
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["archaeology", "Indigenous-history", "accessible", "major-museum"],
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["art", "free-entry", "Botero", "colonial-architecture"],
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["national-history", "art", "architecture", "major-museum"],
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["modern-art", "contemporary-art", "architecture", "temporary-exhibitions"],
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["colonial-art", "religious-history", "architecture", "compact"],
    hours: { mon: "Closed", tue: "9:00 AM-5:00 PM", wed: "9:00 AM-5:00 PM", thu: "9:00 AM-5:00 PM", fri: "9:00 AM-5:00 PM", sat: "9:00 AM-5:00 PM", sun: "9:00 AM-5:00 PM" },
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["city-history", "urbanism", "free-entry", "historic-house"],
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["Independence-history", "historic-house", "gardens", "political-history"],
    hours: { mon: "Closed", tue: "9:00 AM-5:00 PM", wed: "9:00 AM-5:00 PM", thu: "9:00 AM-5:00 PM", fri: "9:00 AM-5:00 PM", sat: "9:00 AM-5:00 PM", sun: "9:00 AM-5:00 PM" },
  ...
  place({
    ...
    category: "Culture", venueKind: "museum", attributeTags: ["memory", "contemporary-art", "peace-process", "free-entry"],
  ...
  place({
    ...
    category: "Culture", venueKind: "cinema", attributeTags: ["film", "media-arts", "public-programming", "accessible"],
...
const activityStops: GuideStop[] = [
  place({
    ...
    category: "Activities", venueKind: "attraction", attributeTags: ["viewpoint", "cable-car", "high-altitude", "pilgrimage"],
  ...
  place({
    ...
    category: "Activities", venueKind: "route", attributeTags: ["cycling", "free", "family-friendly", "citywide"],
  ...
  place({
    ...
    category: "Activities", venueKind: "market", attributeTags: ["public-market", "food", "flowers", "early-morning"],
  ...
  place({
    ...
    category: "Activities", venueKind: "tour", attributeTags: ["street-art", "walking-tour", "artist-led", "city-history"], hours: { default: "Daily tours depart at 10:00 AM and 2:00 PM; private tours and workshops use the times confirmed on the official booking page." },
  ...
  place({
    ...
    category: "Activities", venueKind: "market", attributeTags: ["weekend-market", "crafts", "shopping", "walkable"],
  ...
  place({
    ...
    category: "Activities", venueKind: "park", attributeTags: ["botanical-garden", "páramo", "family-friendly", "accessible"],
  ...
  place({
    ...
    category: "Activities", venueKind: "park", attributeTags: ["urban-park", "walking", "cycling", "family-friendly"],
  ...
  place({
    ...
    category: "Activities", venueKind: "library", attributeTags: ["architecture", "library", "free", "accessible"],
  ...
  place({
    ...
    category: "Activities", venueKind: "trail", attributeTags: ["hiking", "reservation-required", "Andean-forest", "viewpoint"],
  ...
  place({
    ...
    category: "Activities", venueKind: "attraction", attributeTags: ["day-trip", "underground", "architecture", "timed-entry"],
...
export const bogotaCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    "Salsa Rooms, Independent Stages & Late-Night Dance Floors",
    "Nightlife",
    "best-casual-bars",
    "Best Casual Bars in Bogotá",
    "The best casual bars in Bogotá for salsa, live music, queer nightlife, electronic clubs, experimental sound, craft beer, courtyards, and event-led nights.",
    "Bogotá's casual nightlife is driven by programs, not merely addresses. Salsa institutions, queer mega-clubs, experimental listening rooms, warehouse electronic projects, live stages, and brewpub courtyards can change character completely from one date to the next, so the official lineup is part of every recommendation.",
    casualBarStops,

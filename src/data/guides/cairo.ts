...
export const cairoCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    "best-bars",
    "Pubs, Beer Terraces, and Live Cairo Rooms",
    "Casual Cairo nightlife across old Zamalek pubs, Downtown beer halls, New Cairo terraces, Sheikh Zayed stages, sport screens, and event-led live-music institutions.",
    casualBarStops,
    sources.casualBars,
    "Best Casual Bars in Cairo for Pubs, Beer, Live Music, and Group Nights",
    "Current Cairo casual-bar guide with event dependencies, official pages, map evidence, and ten distinct late-night choices.",
  ),
  guide(
    "Nightlife",

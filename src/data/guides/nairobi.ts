...
export const nairobiCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    "best-dive-bars",
    "Beer Gardens, Sports Bars & Unfussy Local Nights",
    "Nairobi's dive-bar equivalents are open-air and social: courtyard venues, local taprooms, sports bars, live-music stages, grills, and long-running neighborhood rooms built around beer and conversation.",
    casualBarStops,
    sourcesFor(
      casualBarStops,
      source("Best Kenya Nairobi nightlife guide", editorial.nightlife),
    ),
    "Best Dive Bars in Nairobi for Beer, Sport, and Live Music",
    "Ten source-backed Nairobi dive bars and no-frills locals, including K1 Klub House, The Alchemist, Brew Bistro, Geco Café, Roadhouse Grill, and more.",
  ),
  guide(
    "Nightlife",

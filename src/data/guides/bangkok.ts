...
const expandedHotelStops = [
  ...
  stop({
    ...
    hours: { default: "Hotel operates daily with 24-hour guest services; restaurant, spa, and check-in schedules vary by booking." },
  ...
  stop({
    ...
    hours: { default: "Hotel operates daily with 24-hour guest services; check-in, dining, and spa schedules vary by booking." },
  ...
  stop({
    ...
    hours: { default: "Hotel operates daily with guest services; check-in, dining, spa, and wellness schedules vary by booking." },
  ...
  stop({
    ...
    hours: { default: "Hotel operates daily with guest services; check-in, dining, rooftop, and event schedules vary by booking." },
...
const expandedCultureStops = [
  ...
  stop({
    ...
    hours: { default: "Typically open Tue-Sun with Monday closure; verify current exhibitions and hours on the official site before going." },
  ...
  stop({
    ...
    hours: { default: "Public shrine access is generally daily; verify current map status before going." },
  ...
  stop({
    ...
    hours: { default: "Temple visiting hours are maintained on official/map listings; verify current status before going." },
  ...
  stop({
    ...
    hours: { default: "Museum hours and closure days vary; verify the official site before going." },
  ...
  stop({
    ...
    hours: { default: "Museum opening days and hours vary; verify the official Fine Arts Department page before going." },

...
bangkokCitywideGuides.push(buildNatureGuide({
  city: "Bangkok", country: "Thailand", continent: "Asia",
  id: "list-bangkok-citywide-nature", slug: "bangkok-best-parks-and-nature-citywide", seoSlug: "best-parks",
  seoTitle: "Best Parks and Nature in Bangkok", seoDescription: "Bangkok nature guide to central parks, lakes, cycling grounds, butterfly habitat, mangroves, and the green lung across the Chao Phraya.",
  title: "Lake Loops, Wetlands, and the Green Lung",
  description: "Bangkok’s green side runs from dawn exercise parks and restored urban wetland to Bang Kachao’s canals and the mangrove edge of the Gulf. Early hours beat the heat, while monsoon weather and managed park gates shape longer outings.",
  createdAt: "2026-07-29T00:00:00.000Z", checkedAt: "2026-08-04",
  sources: [
    { name: "Top organic result: Thailand government Bangkok public park guide", url: "https://thailand.go.th/issue-focus-detail/002_007?hl=en" },
    { name: "Greener Bangkok official park directory", url: "https://greener.bangkok.go.th/en/park/" },
    { name: "Tourism Authority of Thailand Bangkok nature", url: "https://www.tourismthailand.org/Destinations/Provinces/Bangkok/219" },
    { name: "Google Maps - Bangkok parks and nature", url: "https://www.google.com/maps/search/best+parks+and+nature+Bangkok" },
  ],
  stops: [
    { id: "bangkok-nature-lumphini", name: "Lumphini Park", coordinates: [13.7305556, 100.5416667], description: "Lumphini Park is Bangkok’s central exercise ground, with a lake, running loops, shade trees, lawns, paddleboats, and conspicuous water monitors. Dawn brings the most local rhythm and the least punishing temperature.", hours: { mon: "4:30 AM-10:00 PM", tue: "4:30 AM-10:00 PM", wed: "4:30 AM-10:00 PM", thu: "4:30 AM-10:00 PM", fri: "4:30 AM-10:00 PM", sat: "4:30 AM-10:00 PM", sun: "4:30 AM-10:00 PM" }, officialUrl: "https://greener.bangkok.go.th/en/park/lumpini-park/", photo: images.lumphini, subcategory: "urban_park", attributeTags: ["park", "running", "lake", "wildlife", "central"] },
    { id: "bangkok-nature-benjakitti", name: "Benjakitti Forest Park", coordinates: [13.7294, 100.5586], description: "Benjakitti Forest Park turns former tobacco-factory land into ponds, wetland planting, elevated walkways, bike lanes, and a long skyline view. The new forest zone feels more ecological than decorative, especially around sunrise and dusk.", hours: { default: "Daily 4:30 AM–10:00 PM; cycling 6:00 AM–5:30 PM." }, officialUrl: "https://greener.bangkok.go.th/en/park/benjakitti-park/", subcategory: "urban_wetland", attributeTags: ["wetland", "walking", "cycling", "skyline", "accessible"] },
    { id: "bangkok-nature-queen-sirikit", name: "Queen Sirikit Park", coordinates: [13.8066667, 100.55], description: "Queen Sirikit Park concentrates Thai botanical collections, lotus ponds, formal beds, and quiet lawns beside Chatuchak’s busier park complex. Plant labels and compact paths suit visitors who want botany without committing to a remote garden.", hours: { default: "Daily 5:00 AM–7:00 PM." }, officialUrl: "https://greener.bangkok.go.th/en/park/suan-somdet-phranangchao-sirikit/", subcategory: "botanical_park", attributeTags: ["garden", "plants", "pond", "quiet", "free_entry"] },
    { id: "bangkok-nature-wachirabenchathat", name: "Wachirabenchathat Park", coordinates: [13.812, 100.554], description: "Wachirabenchathat, still widely called Rot Fai Park, has broad cycling loops, lawns, ponds, sports space, and the Bangkok Butterfly Garden. Weekends bring families and rented bikes; weekday mornings leave the landscape much looser.", hours: { default: "Daily 4:30 AM–9:00 PM; cycling is permitted throughout park hours." }, officialUrl: "https://greener.bangkok.go.th/en/park/suan-wachirabenjathat-suan-rotfai/", subcategory: "recreation_park", attributeTags: ["cycling", "park", "family_friendly", "butterflies", "lake"] },
    { id: "bangkok-nature-rama-nine", name: "Suan Luang Rama IX", coordinates: [13.6883333, 100.6633333], description: "Suan Luang Rama IX spreads botanical zones, a large reservoir, formal gardens, exercise paths, and flowering displays across Bangkok’s eastern suburbs. Its scale rewards a bicycle or a focused route rather than a hurried circuit.", hours: { default: "Daily 5:00 AM–7:00 PM." }, officialUrl: "https://greener.bangkok.go.th/en/park/suan-luang-r-9/", subcategory: "botanical_park", attributeTags: ["garden", "lake", "cycling", "flowers", "family_friendly"] },
    { id: "bangkok-nature-nong-bon", name: "Nong Bon Lake Park", coordinates: [13.6859, 100.6608], description: "Nong Bon Lake Park pairs a long waterside cycling loop with sailing, kayaking, and windsurfing facilities beside Suan Luang Rama IX. Water-sport access requires registration and follows the center’s operating schedule.", hours: { default: "Park daily 4:30 AM–6:30 PM. Water Sports Center sessions: 12:00–2:30 PM and 3:00–6:00 PM; membership and reservation are required." }, officialUrl: "https://greener.bangkok.go.th/en/park/suan-satharana-sun-gi-la-bueng-nong-bon/", photo: "https://commons.wikimedia.org/wiki/File:Little_Egret_flying_-_Thailand.jpg", subcategory: "lake_park", attributeTags: ["lake", "cycling", "kayaking", "sailing", "active"] },
    { id: "bangkok-nature-bang-kachao", name: "Bang Kachao", coordinates: [13.6807, 100.5663], description: "Bang Kachao threads elevated lanes, orchards, canals, stilt houses, markets, and pockets of forest through the Chao Phraya’s great bend. Bicycle traffic and heat make an early, unhurried loop far more rewarding than a rushed afternoon dash.", hours: { default: "Roads, lanes, and community landscapes are open 24 hours daily; local ferries, markets, rentals, and attractions keep separate posted schedules." }, officialUrl: "https://www.tourismthailand.org/Attraction/bang-krachao", subcategory: "river_peninsula", attributeTags: ["cycling", "canals", "forest", "ferry", "day_trip"] },
    { id: "bangkok-nature-si-nakhon", name: "Si Nakhon Khuean Khan Park", coordinates: [13.6975, 100.565], description: "Si Nakhon Khuean Khan Park protects ponds, forest, bird habitat, and a watchtower within Bang Kachao’s greener interior. Flat paths work for slow cycling, but birding is best before midday noise and humidity rise.", hours: { default: "Daily 6:00 AM–7:00 PM." }, officialUrl: "https://www.tourismthailand.org/Attraction/sri-nakhon-khuean-khan-park-and-botanical-garden", subcategory: "wetland_park", attributeTags: ["birdwatching", "wetland", "cycling", "forest", "quiet"] },
    { id: "bangkok-nature-butterfly-garden", name: "Bangkok Butterfly Garden and Insectarium", coordinates: [13.8095, 100.5549], description: "Bangkok Butterfly Garden keeps a planted flight dome, breeding areas, and interpretation on regional butterflies inside the Rot Fai Park complex. It is compact and family-friendly, with opening days more restrictive than the surrounding park.", hours: { default: "Tuesday–Sunday 8:30 AM–4:30 PM; closed Monday." }, officialUrl: "https://greener.bangkok.go.th/en/park/suan-wachirabenjathat-suan-rotfai/", subcategory: "butterfly_garden", attributeTags: ["butterflies", "family_friendly", "garden", "free_entry"] },
    { id: "bangkok-nature-bang-khun-thian", name: "Bang Khun Thian Mangrove Forest", coordinates: [13.5549, 100.4427], description: "Bang Khun Thian’s mangrove edge reveals the coastal Bangkok that the dense center hides, with boardwalks, mudflats, aquaculture ponds, and birdlife facing the Gulf. Tide, monsoon rain, and restoration closures can materially change access.", hours: { default: "Daily 5:00 AM–9:00 PM; boardwalk restrictions may apply during restoration or severe weather." }, officialUrl: "https://greener.bangkok.go.th/en/", photo: "https://commons.wikimedia.org/wiki/File:%E0%B8%95%E0%B9%89%E0%B8%99%E0%B9%82%E0%B8%81%E0%B8%87%E0%B8%81%E0%B8%B2%E0%B8%87_%E0%B8%97%E0%B8%B5%E0%B9%88%E0%B9%80%E0%B8%97%E0%B8%B5%E0%B8%A2%E0%B8%99%E0%B8%97%E0%B8%B0%E0%B9%80%E0%B8%A5_-_panoramio.jpg", subcategory: "mangrove_forest", attributeTags: ["mangrove", "birdwatching", "boardwalk", "coast", "day_trip"] },
  ],
}));

...
const expandedCasualBarStops = [
  ...casualBarStops,
  stop({
    id: "bangkok-casual-rock-pub",
    poiId: "bangkok-venue-rock-pub",
    name: "The Rock Pub",
    coordinates: [13.7726, 100.5421],
    description:
      "The Rock Pub has been Bangkok's dedicated rock and metal live house since 1987, with local bands, touring acts, and a compact room built around the stage rather than bottle service.",
    venueKind: "nightlife",
    nightlifeType: "live_music_venue",
    musicGenres: ["rock", "metal", "punk", "alternative"],
    price: "$$",
    priceSource: "Official LINE account / current listings",
    attributeTags: ["live_music", "rock", "metal", "local_bar"],
    hours: {
      mon: "Closed",
      tue: "18:00-00:30",
      wed: "18:00-00:30",
    ...
    officialUrl: "https://page.line.me/cxf2154b",
    sourcePhoto: "https://touristbangkok.com/wp-content/uploads/2018/06/Rock-Pub-1.jpg",
    editorialUrls: ["https://www.timeout.com/bangkok/nightlife/the-rock-pub", "https://www.theconcert.com/therockpub", "https://restaurantguru.com/The-Rock-Pub-Bangkok-3"],
  }),
  stop({
    ...
    hours: { default: "Daily 19:00-01:00" },
    officialUrl: "https://www.facebook.com/adhere13thbluesbar",
    sourcePhoto: "https://ksr-media-802927501686.s3.us-west-2.amazonaws.com/large_adhere_the_13th_blues_bar_featured_a3e3b84892.jpg",
    editorialUrls: ["https://www.timeout.com/bangkok/bars/adhere-the-13th", "https://restaurantguru.com/Adhere-13th-blues-bar-Bangkok-2", "https://www.khaosanroad.com/places/adhere-the-13th-blues-bar"],
  }),
  stop({
  ...
  stop({
    ...
    hours: { default: "The official event calendar publishes doors and closing time for each DJ night or live program." },
    officialUrl: "https://www.instagram.com/12x12bkk/",
    sourcePhoto: "https://api.nightify.co/imgproxy/9tkyPE5LakP_XUapbVnRW8LRnTA5VwMxA3N1JbquWiA/rs:fill:640:360:0/plain/https://img.nightify.co/images/12x12-WUpoQP.webp@webp",
    editorialUrls: ["https://www.timeout.com/bangkok/bars/12-x-12", "https://nightify.co/venues/12x12"],
  }),
  stop({
  ...
  stop({
    ...
    sourcePhoto: "https://d1ef7ke0x2i9g8.cloudfront.net/bangkok/_800x418_crop_center-center_82_none/Instagram-BROWN-SUGAR-Bangkok.jpg?mtime=1724143540",
    editorialUrls: ["https://www.timeout.com/bangkok/music/brown-sugar", "https://fridaybangkok.com/v/brown-sugar", "https://thebeat.asia/bangkok/delish/reviews/no-frills-7-dive-bars-worth-checking-out-in-bangkok"],
  }),
  stop({
...
export const bangkokCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    "best-dive-bars",
    "Neon Dives, Blues Bars, and Easy Beer",
    "Bangkok's dive-bar side runs through live Thai music in Chinatown, Victory Monument jazz, Ekkamai beer rooms, and low-pressure neighborhood bars where conversation and sound matter more than club logistics.",
    expandedCasualBarStops,
    sources.casualBars,
    "Best Dive Bars in Bangkok",
    "Best dive bars in Bangkok for live music, Thai spirits, jazz pubs, easy beer, current hours, and lower-pressure nights.",
  ),
  guide(
    "Nightlife",

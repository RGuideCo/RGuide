...
export const aucklandCitywideGuides: MapList[] = [
  ...
  guide("Nightlife", "list-auckland-casual-bars", "auckland-best-pubs-and-casual-bars", "best-dive-bars", "Sticky Floors, Live Rooms & Neighborhood Pints", "Auckland's best dive-bar nights run through old pubs, student rooms, courtyard taverns, underground bands, open-mic rock, sports, and Ponsonby locals where beer matters more than polish.", pubStops, sourcesFor(pubStops, source("AucklandNZ bar and nightlife inventory", editorial.pubs)), "Best Dive Bars in Auckland for Beer, Music, and Late Nights", "Ten current Auckland dive bars and low-key pubs spanning Galbraith's, the Occidental, Whammy, Portland Public House, Ponsonby locals, courtyards, and live music."),

...
export const sydneyCitywideGuides: MapList[] = [
  guide(
    ...
    "best-restaurants",
    "Sydney Restaurants Worth Planning Around",
  ...
  guide(
    ...
    "best-cheap-eats",
    "Sydney Cheap Eats Across the City's Food Cultures",
  ...
  guide(
    ...
    "best-hotels",
    "Sydney Hotels by Harbor, Beach, and Neighborhood",
  ...
  guide(
    ...
    "best-hostels",
    "Sydney Hostels for Social Trips, Beaches, and Quiet Harbor Beds",
  ...
  guide(
    ...
    "best-bars",
    "Sydney Pubs, Dive Bars, and Casual Late Rooms",
  ...
  guide(
    ...
    "best-cocktail-bars",
    "Sydney Cocktail Bars With a Point of View",
  ...
  guide(
    ...
    "best-culture",
    "Sydney Museums, Galleries, and Cultural Landmarks",
  ...
  guide(
    ...
    "best-things-to-do",
    "Ten Sydney Experiences That Explain the City",

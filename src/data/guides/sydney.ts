...
export const sydneyCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    pubStops,
    sources.pubs,
    "Best Pubs and Casual Bars in Sydney for Local, Live, and Late Nights",
...
sydneyCitywideGuides.push(buildNatureGuide({
  city: "Sydney", country: "Australia", continent: "Oceania",
  id: "list-sydney-citywide-nature", slug: "sydney-best-walks-and-nature-citywide", seoSlug: "best-walks-and-nature",
  seoTitle: "Best Walks and Nature in Sydney", seoDescription: "Sydney nature guide to harbour gardens, coastal walks, national parks, sandstone headlands, bushland, and native botanical collections.",
  title: "Sandstone Headlands, Harbour Bush, and Ocean Walks",
  description: "Sydney’s nature is inseparable from water and sandstone: harbour gardens, cliff walks, surf beaches, heath, eucalyptus bush, and national parks begin inside the metro. Heat, swell, tides, bushfire danger, track closures, and ferry schedules determine the safe route.",
  createdAt: "2026-07-29T00:00:00.000Z", checkedAt: "2026-08-04",
  sources: [
    { name: "Top organic result: Sydney official coastal walks", url: "https://www.sydney.com/things-to-do/nature-and-parks/walks" },
    { name: "NSW National Parks official", url: "https://www.nationalparks.nsw.gov.au/" },
    { name: "City of Sydney parks", url: "https://www.cityofsydney.nsw.gov.au/parks-playgrounds" },
    { name: "Google Maps - Sydney walks and nature", url: "https://www.google.com/maps/search/best+walks+and+nature+Sydney" },
  ],
  stops: [
    { id: "sydney-nature-royal-botanic", name: "Royal Botanic Garden Sydney", coordinates: [-33.8642, 151.2166], description: "The Royal Botanic Garden curves around Farm Cove with subtropical collections, native plants, old figs, lawns, and direct harbour views. Free guided walks and plant interpretation provide depth beyond the famous Opera House photograph.", hours: { default: "Daily from 7:00 AM: November–February until 8:00 PM; March until 6:30 PM; April and September until 6:00 PM; May and August until 5:30 PM; June–July until 5:00 PM; October until 7:30 PM." }, officialUrl: "https://www.botanicgardens.org.au/royal-botanic-garden-sydney", subcategory: "harbour_botanical_garden", attributeTags: ["garden", "harbour", "plants", "free_entry", "central"] },
    { id: "sydney-nature-bondi-coogee", name: "Bondi to Coogee Coastal Walk", coordinates: [-33.891, 151.277], description: "The Bondi–Coogee path crosses sandstone cliffs, surf beaches, rock pools, coves, and exposed headlands over six busy kilometers. Sun, stairs, crowding, and strong surf matter, while multiple transport exits make shorter sections easy.", hours: { default: "Open 24 hours daily." }, officialUrl: "https://www.sydney.com/things-to-do/nature-and-parks/walks/bondi-to-coogee-coastal-walk", subcategory: "coastal_walk", attributeTags: ["walking", "cliffs", "beach", "swimming", "public_transit"] },
    { id: "sydney-nature-spit-manly", name: "Spit to Manly Walk", coordinates: [-33.804, 151.244], description: "The Spit–Manly route threads harbour bush, beaches, Aboriginal rock engravings, sandstone, and coves before reaching Manly. Tide affects shoreline details, while steep steps and exposed sections accumulate across the ten-kilometer walk.", hours: { default: "Open 24 hours daily; the Castle Rock section currently uses a signed detour during track upgrades." }, officialUrl: "https://www.northernbeaches.nsw.gov.au/things-to-do/recreation-area/manly-scenic-walkway", subcategory: "harbour_bushwalk", attributeTags: ["hiking", "harbour", "beach", "aboriginal_heritage", "ferry"] },
    { id: "sydney-nature-blue-mountains", name: "Blue Mountains National Park", coordinates: [-33.617, 150.455], description: "Blue Mountains National Park protects sandstone escarpments, eucalyptus forest, waterfalls, canyons, and long walking tracks west of Sydney. Weather and fire can close routes quickly, while famous lookouts reveal only the easiest edge of a huge landscape.", hours: { default: "Open 24 hours daily; Glenbrook vehicle gates daily 8:30 AM–7:00 PM from the first Sunday in October to the first Sunday in April and 8:30 AM–6:00 PM the rest of the year." }, officialUrl: "https://www.nationalparks.nsw.gov.au/visit-a-park/parks/blue-mountains-national-park/visitor-info", subcategory: "sandstone_national_park", attributeTags: ["mountain", "hiking", "forest", "waterfall", "day_trip"] },
    { id: "sydney-nature-royal-national", name: "Royal National Park", coordinates: [-34.123, 151.058], description: "Royal National Park combines coastal cliffs, heath, rainforest gullies, beaches, rivers, and long tracks south of Sydney. Figure Eight Pools and other social-media routes carry tide and rescue risk, making conservative official advice essential.", hours: { default: "Daily 7:00 AM–8:30 PM." }, officialUrl: "https://www.nationalparks.nsw.gov.au/visit-a-park/parks/royal-national-park/visitor-info", subcategory: "coastal_national_park", attributeTags: ["hiking", "cliffs", "forest", "beach", "day_trip"] },
    { id: "sydney-nature-ku-ring-gai", name: "Ku-ring-gai Chase National Park", coordinates: [-33.62, 151.2], description: "Ku-ring-gai Chase protects sandstone plateau, eucalyptus bush, coves, Aboriginal cultural sites, and Hawkesbury water north of Sydney. Trailheads are dispersed, and car, ferry, or bus logistics materially change which walk is practical.", hours: { default: "Open 24 hours daily. West Head vehicle gates daily 6:00 AM–8:30 PM during daylight saving and 6:00 AM–6:00 PM the rest of the year; Sphinx Memorial carpark gate closes at 7:00 PM." }, officialUrl: "https://www.nationalparks.nsw.gov.au/visit-a-park/parks/ku-ring-gai-chase-national-park/visitor-info", subcategory: "harbour_bushland_national_park", attributeTags: ["hiking", "aboriginal_heritage", "harbour", "forest", "day_trip"] },
    { id: "sydney-nature-barangaroo", name: "Barangaroo Reserve", coordinates: [-33.854, 151.201], description: "Barangaroo Reserve rebuilds a sandstone headland with native planting, tidal pools, lawns, and harbour paths above engineered infrastructure. The landscape is new and deliberate, offering accessible foreshore rather than recovered wilderness.", hours: { default: "Open 24 hours daily." }, officialUrl: "https://www.barangaroo.com/see-do-stay/swim-at-marrinawi-cove", subcategory: "restored_harbour_headland", attributeTags: ["harbour", "native_plants", "walking", "accessible", "central"] },
    { id: "sydney-nature-centennial", name: "Centennial Parklands", coordinates: [-33.898, 151.235], description: "Centennial Parklands combine ponds, fig avenues, lawns, paperbark swamp, horse tracks, and cycling circuits across Sydney’s eastern inner city. Waterbirds and old trees provide ecological texture beneath heavy everyday recreation.", hours: { default: "During daylight saving daily 6:00 AM–8:00 PM; April after daylight saving and September before daylight saving daily 6:00 AM–6:00 PM; May–August daily 6:30 AM–5:30 PM." }, officialUrl: "https://www.centennialparklands.com.au/visit/opening-hours", subcategory: "metropolitan_parklands", attributeTags: ["park", "pond", "cycling", "birdwatching", "family_friendly"] },
    { id: "sydney-nature-harbour-np", name: "Sydney Harbour National Park", coordinates: [-33.822, 151.267], description: "Sydney Harbour National Park protects scattered headlands, islands, beaches, and bushland around the harbour, including North Head and Middle Head. Each precinct has different ferry, road, and walking access, so the park works as selected fragments rather than one destination.", hours: { default: "Official park access is daily from sunrise to sunset, approximately 6:00 AM–6:00 PM April–September and 5:30 AM–8:00 PM October–March. North Head vehicle gates daily 6:00 AM–8:30 PM during daylight saving and 6:00 AM–6:00 PM the rest of the year." }, officialUrl: "https://www.nationalparks.nsw.gov.au/visit-a-park/parks/sydney-harbour-national-park", subcategory: "harbour_national_park", attributeTags: ["harbour", "hiking", "headland", "beach", "historic"] },
    { id: "sydney-nature-mount-annan", name: "Australian Botanic Garden Mount Annan", coordinates: [-34.07, 150.768], description: "Mount Annan dedicates vast hills, lakes, woodland, and research collections to Australian native plants on Sydney’s southwest edge. The scale suits driving or cycling between areas, while summer heat makes walking the entire garden unrealistic.", hours: { default: "Daily 8:00 AM–7:00 PM January–March and from the first Sunday in October through December; daily 8:00 AM–5:00 PM from the first Sunday in April through the first Sunday in October." }, officialUrl: "https://www.botanicgardens.org.au/australian-botanic-garden-mount-annan/plan-your-visit", subcategory: "native_botanical_garden", attributeTags: ["native_plants", "garden", "lake", "cycling", "day_trip"] },
  ],
}));

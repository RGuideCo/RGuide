...
const hoursByName: Record<string, StopHours> = {
  ...
  "Miami Design District": daily("District public realm is accessible daily; official district pages list store, gallery, restaurant, and museum schedules."),
...
const images = {
  ...
  generatorMiami: "https://media.gq.com/photos/5bc0d76dedc74a079214d8a9/16:9/w_2560,c_limit/generator-hotel-review-miami-gq.jpg",
  casaRosa: "https://a.hwstatic.com/image/upload/f_auto,q_auto,t_40/propertyimages/3/308490/dubu1prakmfqioclllph.jpg",
  islandHouse: "https://a.hwstatic.com/image/upload/f_auto,q_auto,t_40/propertyimages/2/21058/1.jpg",
  utopia: "https://a.hwstatic.com/image/upload/f_auto,q_auto,t_40/propertyimages/3/335257/ztfrmjj9eqceal295g9z.jpg",
};
...
const diningStops = [
  stop({ id: "miami-dining-joes", name: "Joe's Stone Crab", coordinates: [25.76903, -80.13558], description: "Joe's is an old Miami Beach institution built around stone crab claws in season, fried chicken beyond crab season, tuxedoed service, and a confident dining room. The main room does not take reservations, so early arrival matters.", officialUrl: "https://joesstonecrab.com/", photo: images.joes, hours: { default: "Seasonal restaurant hours vary between the main dining room, takeaway, and summer service; use the official hours page before going." }, price: "$$$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["seafood", "stone_crab", "american"], attributeTags: ["classic", "seafood", "reservation_recommended", "historic", "destination_dining"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://guide.michelin.com/us/en/florida/miami-beach/restaurant/joe-s-stone-crab"] }),
  stop({ id: "miami-dining-versailles", name: "Versailles Restaurant", coordinates: [25.765267, -80.25323], description: "Versailles packs mirrored rooms, Cuban coffee windows, croquetas, ropa vieja, and political gossip into a Calle Ocho institution. The ventanita offers the abbreviated cafecito-and-pastry version; inside, the full menu supplies a broad Miami Cuban baseline.", officialUrl: "https://versaillesrestaurant.com/", photo: images.versailles, hours: daily("breakfast through late dinner; exact holiday hours should be checked on the official listing."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["cuban", "cafe", "bakery"], attributeTags: ["classic", "breakfast", "late_night", "family_friendly_food", "walk_in_friendly"], editorialUrls: ["https://www.miamiandbeaches.com/l/eat-and-drink/versailles-restaurant/2325", "https://www.timeout.com/miami/restaurants/versailles"] }),
  stop({ id: "miami-dining-mandolin", name: "Mandolin Aegean Bistro", coordinates: [25.815073, -80.190734], description: "Mandolin serves grilled fish, meze, and Greek-Turkish comfort in a shaded Design District courtyard. Book ahead and settle in; the room and cooking reward a slower lunch.", officialUrl: "https://www.mandolinmiami.com/", photo: images.mandolin, hours: daily("lunch and dinner service; reservations and weather-sensitive courtyard seating should be checked before going."), price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["greek", "turkish", "mediterranean"], attributeTags: ["romantic_food", "scenic_food", "reservation_recommended", "outdoor_seating", "design_district"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://www.theinfatuation.com/miami/reviews/mandolin-aegean-bistro"] }),
  stop({ id: "miami-dining-michaels", name: "Michael's Genuine Food & Drink", coordinates: [25.814922, -80.192036], description: "Michael's Genuine is a Design District grown-up restaurant, less about spectacle than seasonal plates, good wine, and a room that helped make modern Miami dining feel local.", officialUrl: "https://www.michaelsgenuine.com/", photo: images.michaels, hours: { default: "Official site posts lunch, dinner, brunch, and happy-hour schedules by day; use official page service before booking." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["american", "seasonal", "new_american"], attributeTags: ["reservation_recommended", "wine", "brunch", "local_favorite", "design_district"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://guide.michelin.com/us/en/florida/miami/restaurant/michael-s-genuine-food-drink"] }),
  stop({ id: "miami-dining-stubborn-seed", name: "Stubborn Seed", coordinates: [25.772986, -80.134297], description: "Stubborn Seed is the South Beach tasting-menu counterweight to the party postcard: Jeremy Ford's kitchen is polished, intense, and better for a planned dinner than a casual wander-in.", officialUrl: "https://www.stubbornseed.com/", photo: images.stubbornSeed, hours: { default: "Dinner and tasting-menu availability are posted by reservation date; closed days and seating times vary, so use before booking." }, price: "$$$$", priceSource: "Official reservation platform / MICHELIN Guide", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["modern_american", "tasting_menu", "fine_dining"], attributeTags: ["fine_dining", "tasting_menu", "reservation_recommended", "date_night", "splurge_food"], editorialUrls: ["https://guide.michelin.com/us/en/florida/miami-beach/restaurant/stubborn-seed", "https://miami.eater.com/maps/miami-best-restaurants-38"] }),
  ...
  stop({ id: "miami-dining-macchialina", name: "Macchialina", coordinates: [25.785317, -80.141582], description: "Macchialina is the South Beach Italian room to use for pasta, wine, and a little neighborhood friction instead of another hotel dining room.", officialUrl: "https://macchialina.com/", photo: images.macchialina, hours: { default: "Dinner hours and weekly specials are posted by day on the official site; use same-week service before going." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["italian", "pasta", "wine"], attributeTags: ["reservation_recommended", "date_night", "wine", "south_beach", "local_favorite"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://www.theinfatuation.com/miami/reviews/macchialina"] }),
  stop({ id: "miami-dining-zak", name: "Zak the Baker", coordinates: [25.801434, -80.201995], description: "Zak the Baker is a Wynwood breakfast and lunch bakery that proves Miami food is not only late nights and hotel tabs: sourdough, babka, sandwiches, salads, and a bakery line with real turnover.", officialUrl: "https://www.zakthebaker.com/", photo: images.zak, hours: { default: "Official bakery hours vary by weekday and weekend service; use official page hours before routing a morning around it." }, price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "bakery", cuisineTypes: ["bakery", "jewish", "breakfast"], attributeTags: ["breakfast", "bakery", "vegetarian_friendly", "walk_in_friendly", "wynwood"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://www.timeout.com/miami/restaurants/zak-the-baker"] }),
  stop({ id: "miami-dining-surf-club", name: "The Surf Club Restaurant", coordinates: [25.878094, -80.121645], description: "The Surf Club Restaurant is Thomas Keller doing old Florida glamour with restraint: polished service, Continental references, and a dining room that feels built for occasion travel.", officialUrl: "https://www.surfclubrestaurant.com/", photo: images.surfClub, hours: { default: "Lunch, dinner, and lounge hours vary by day and reservation availability; use the official booking calendar." }, price: "$$$$", priceSource: "Official menu / MICHELIN Guide", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["american", "continental", "fine_dining"], attributeTags: ["fine_dining", "romantic_food", "reservation_recommended", "splurge_food", "historic"], editorialUrls: ["https://guide.michelin.com/us/en/florida/surfside/restaurant/the-surf-club-restaurant", "https://miami.eater.com/maps/miami-best-restaurants-38"] }),
  stop({ id: "miami-dining-chef-creole", name: "Chef Creole", coordinates: [25.835787, -80.190638], description: "Chef Creole serves Haitian seafood, griot, conch, snapper, pikliz, rice, and direct Creole heat in a casual Little Haiti restaurant that makes Miami's Caribbean food culture explicit.", officialUrl: "https://chefcreole.com/", photo: images.chefCreole, hours: daily("lunch and dinner service; verify current location hours before going."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["haitian", "caribbean", "seafood"], attributeTags: ["caribbean_food", "seafood", "casual", "local_favorite", "little_haiti"], editorialUrls: ["https://miami.eater.com/maps/best-haitian-restaurants-miami", "https://www.miamiandbeaches.com/l/eat-and-drink/chef-creole/2616"] }),
];
...
const cheapEatStops = [
  ...
  stop({ id: "miami-cheap-la-sandwicherie", name: "La Sandwicherie", coordinates: [25.78649, -80.131913], description: "La Sandwicherie turns French-style sandwiches, vinaigrette, and a tiny counter into a fast meal built for speed rather than lingering.", officialUrl: "https://lasandwicherie.com/", photo: images.laSandwicherie, hours: daily("long counter-service hours; late-night availability varies by location and should be verified."), price: "$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "counter_service", cuisineTypes: ["sandwiches", "french", "salads"], attributeTags: ["quick_meal", "budget_food", "late_night", "walk_in_friendly", "beach"], editorialUrls: ["https://www.timeout.com/miami/restaurants/la-sandwicherie", "https://www.theinfatuation.com/miami/reviews/la-sandwicherie"] }),
  stop({ id: "miami-cheap-enriquetas", name: "Enriqueta's Sandwich Shop", coordinates: [25.800123, -80.193552], description: "Enriqueta's is a Wynwood/Edgewater Cuban breakfast and sandwich counter with less spectacle and more substance: tostadas, cafe, medianoches, and straightforward plates. Go early, expect a tight counter, and do not make it fight for attention against a long gallery day.", officialUrl: "https://enriquetas.com/", photo: images.enriquetas, hours: { default: "Breakfast and lunch hours are posted by current listings; use same-day hours because service is not a late-night format; official page controls the posted schedule." }, price: "$", priceSource: "Official/menu listing / Google Maps", venueKind: "food_drink", foodServiceType: "counter_service", cuisineTypes: ["cuban", "breakfast", "sandwiches"], attributeTags: ["breakfast", "budget_food", "quick_meal", "local_favorite", "walk_in_friendly"], editorialUrls: ["https://miami.eater.com/maps/best-cuban-restaurants-miami", "https://www.theinfatuation.com/miami/reviews/enriquetas-sandwich-shop"] }),
  ...
  stop({ id: "miami-cheap-doggis", name: "Doggi's Arepa Bar", coordinates: [25.754166, -80.20933], description: "Doggi's serves arepas, cachapas, pepitos, and a broad range of Venezuelan fast-casual dishes that handle groups without becoming expensive.", officialUrl: "https://www.eatdoggis.com/", photo: images.doggis, hours: daily("lunch through dinner service; location-specific hours should be checked before routing."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "fast_casual", cuisineTypes: ["venezuelan", "arepas", "latin_american"], attributeTags: ["budget_food", "quick_meal", "group_friendly", "casual", "latin_food"], editorialUrls: ["https://miami.eater.com/maps/best-arepas-miami", "https://www.theinfatuation.com/miami/reviews/doggis-arepa-bar"] }),
  stop({ id: "miami-cheap-coyo", name: "Coyo Taco Wynwood", coordinates: [25.80091, -80.199865], description: "Coyo Taco is not obscure, but it is useful: tacos, quick turnover, a Wynwood address, and enough late energy to keep a casual night moving.", officialUrl: "https://www.coyo-taco.com/", photo: images.coyo, hours: daily("lunch, dinner, and late service by location; verify Wynwood hours before counting on late food."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "fast_casual", cuisineTypes: ["tacos", "mexican", "counter_service"], attributeTags: ["quick_meal", "late_night", "group_friendly", "wynwood", "walk_in_friendly"], editorialUrls: ["https://miami.eater.com/maps/best-tacos-miami", "https://www.timeout.com/miami/restaurants/coyo-taco"] }),
  stop({ id: "miami-cheap-taquiza", name: "Taquiza", coordinates: [25.772922, -80.134093], description: "Taquiza builds tacos and crisp totopos around fresh masa, with fillings and salsas that offer far more character than South Beach hotel snacks. Branches have shifted over time, so confirm the current location.", officialUrl: "https://www.taquiza.com/", photo: images.taquiza, hours: daily("counter-service hours by location; verify current branch hours before going."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "counter_service", cuisineTypes: ["tacos", "mexican", "masa"], attributeTags: ["quick_meal", "casual", "beach", "walk_in_friendly", "budget_food"], editorialUrls: ["https://miami.eater.com/maps/best-tacos-miami", "https://www.theinfatuation.com/miami/reviews/taquiza"] }),
  stop({ id: "miami-cheap-motek", name: "Motek Downtown", coordinates: [25.774347, -80.193038], description: "Motek serves Israeli-Mediterranean hummus, shakshuka, schnitzel, salads, and generous plates that work well for mixed groups. It costs more than Miami's cheapest counters, but the broad menu handles both lunch and dinner cleanly.", officialUrl: "https://motekcafe.com/", photo: images.motek, hours: daily("breakfast, lunch, and dinner service by location; verify Downtown hours before routing."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["israeli", "mediterranean", "middle_eastern"], attributeTags: ["vegetarian_friendly", "group_friendly", "brunch", "downtown", "casual"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://www.theinfatuation.com/miami/reviews/motek"] }),
  stop({ id: "miami-cheap-pincho", name: "Pincho", coordinates: [25.729584, -80.241797], description: "Pincho serves burgers, rice bowls, and skewers in a quick fast-casual format with Latin American seasoning. The broad menu handles groups without requiring a reservation.", officialUrl: "https://pincho.com/", photo: images.pincho, hours: daily("lunch and dinner service by branch; verify the selected location before going."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "fast_casual", cuisineTypes: ["burgers", "kebabs", "latin_american"], attributeTags: ["quick_meal", "group_friendly", "casual", "budget_food", "family_friendly_food"], editorialUrls: ["https://www.timeout.com/miami/restaurants/pincho-factory", "https://miami.eater.com/maps/best-burgers-miami"] }),
  stop({ id: "miami-cheap-ms-cheezious", name: "Ms. Cheezious", coordinates: [25.829319, -80.192628], description: "Ms. Cheezious turns grilled cheese into full fast-casual comfort food through loaded sandwiches, soups, fries, and playful combinations. Refinement is not the point; crisp bread, melted cheese, and an easy bill are.", officialUrl: "https://www.mscheezious.com/", photo: images.msCheezious, hours: daily("lunch and dinner service; confirm current restaurant hours and food-truck events before going."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "fast_casual", cuisineTypes: ["grilled_cheese", "american", "comfort_food"], attributeTags: ["casual", "quick_meal", "family_friendly_food", "budget_food", "comfort_food"], editorialUrls: ["https://www.timeout.com/miami/restaurants/ms-cheezious", "https://miami.eater.com/maps/best-cheap-eats-miami"] }),
];

const hotelStops = [
  stop({ id: "miami-hotel-setai", name: "The Setai, Miami Beach", coordinates: [25.796428, -80.128211], description: "The Setai is a calm South Beach luxury hotel with disciplined service, an Art Deco base, Asian-influenced interiors, three pools, and a beachfront position. Its restraint offers a marked contrast to Miami Beach's louder resorts.", officialUrl: "https://www.thesetaihotels.com/", bookingUrl: "https://www.thesetaihotels.com/", photo: images.setai, hours: alwaysOpen, price: "$$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["luxury", "beach", "quiet", "romantic", "wellness"], editorialUrls: ["https://www.cntraveler.com/hotels/miami-beach/the-setai-miami-beach", "https://www.miamiandbeaches.com/l/hotels/the-setai/3548"] }),
  stop({ id: "miami-hotel-faena", name: "Faena Hotel Miami Beach", coordinates: [25.807381, -80.123399], description: "Faena is Mid-Beach maximalism: red, gold, theater, Damien Hirst spectacle, and a hotel campus that treats dinner, cabaret, spa, and beach as one production. Book it when the stay itself is part of the trip, not for a quiet bargain near the clubs.", officialUrl: "https://www.faena.com/miami-beach", bookingUrl: "https://www.faena.com/miami-beach", photo: images.faena, hours: alwaysOpen, price: "$$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["luxury", "design", "beach", "nightlife_nearby", "romantic"], editorialUrls: ["https://www.cntraveler.com/hotels/miami-beach/faena-hotel-miami-beach", "https://www.forbestravelguide.com/hotels/miami-florida/faena-hotel-miami-beach"] }),
  stop({ id: "miami-hotel-one", name: "1 Hotel South Beach", coordinates: [25.798961, -80.1274], description: "1 Hotel South Beach is the beach stay for scale, greenery, big pools, wellness language, and a softer luxury mood than the neon side of South Beach. It is expensive but practical for families and couples who want the ocean, gym, food, and rooms to do most of the work.", officialUrl: "https://www.1hotels.com/south-beach", bookingUrl: "https://www.1hotels.com/south-beach", photo: images.oneHotel, hours: alwaysOpen, price: "$$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["luxury", "wellness", "beach", "family_friendly", "design"], editorialUrls: ["https://www.cntraveler.com/hotels/miami-beach/1-hotel-south-beach", "https://www.travelandleisure.com/hotels-resorts/beach-hotels/1-hotel-south-beach-miami-review"] }),
  stop({ id: "miami-hotel-betsy", name: "The Betsy Hotel", coordinates: [25.786345, -80.129964], description: "The Betsy is Ocean Drive without the cartoon version of Ocean Drive: a literary, art-forward boutique hotel with a quieter lobby culture and easy beach access.", officialUrl: "https://www.thebetsyhotel.com/", bookingUrl: "https://www.thebetsyhotel.com/", photo: images.betsy, hours: alwaysOpen, price: "$$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["boutique", "beach", "design", "romantic", "central"], editorialUrls: ["https://www.cntraveler.com/hotels/miami-beach/the-betsy-south-beach", "https://www.miamiandbeaches.com/l/hotels/the-betsy-south-beach/3187"] }),
  ...
  stop({ id: "miami-hotel-east", name: "EAST Miami", coordinates: [25.767478, -80.193598], description: "EAST Miami is the Brickell base for skyline views, transit, shopping, rooftop drinks, and a downtown-business rhythm rather than beach logistics. It works especially well when the trip includes Brickell, Downtown, or late nights that should end near the room.", officialUrl: "https://www.easthotels.com/en/miami/", bookingUrl: "https://www.easthotels.com/en/miami/", photo: images.eastMiami, hours: alwaysOpen, price: "$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["central", "nightlife_nearby", "work_friendly", "scenic", "design"], editorialUrls: ["https://www.cntraveler.com/hotels/miami/east-miami", "https://www.miamiandbeaches.com/l/hotels/east-miami/3645"] }),
  stop({ id: "miami-hotel-mr-c", name: "Mr. C Miami Coconut Grove", coordinates: [25.728865, -80.241673], description: "Mr. C gives Coconut Grove a polished stay with Biscayne Bay angles, yacht-club energy, and an Italian-hospitality tone that feels far from South Beach.", officialUrl: "https://www.mrchotels.com/miami-coconut-grove", bookingUrl: "https://www.mrchotels.com/miami-coconut-grove", photo: images.mrC, hours: alwaysOpen, price: "$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["boutique", "scenic", "romantic", "quiet", "coconut_grove"], editorialUrls: ["https://www.cntraveler.com/hotels/miami/mr-c-miami-coconut-grove", "https://www.miamiandbeaches.com/l/hotels/mr-c-miami-coconut-grove/42416"] }),
  stop({ id: "miami-hotel-life-house", name: "Life House Little Havana", coordinates: [25.766122, -80.213214], description: "Life House Little Havana is a neighborhood-base hotel when Calle Ocho, Cuban food, and a more local-feeling stay matter more than the beach. Rooms are compact and design-led, so read categories carefully; the advantage is being near Little Havana nights without defaulting to South Beach.", officialUrl: "https://www.life-house.com/hotels/little-havana", bookingUrl: "https://www.life-house.com/hotels/little-havana", photo: images.lifeHouse, hours: alwaysOpen, price: "$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["boutique", "midrange", "central", "little_havana", "design"], editorialUrls: ["https://www.cntraveler.com/hotels/miami/life-house-little-havana", "https://www.miamiandbeaches.com/l/hotels/life-house-little-havana/42397"] }),
  stop({ id: "miami-hotel-mayfair", name: "Mayfair House Hotel & Garden", coordinates: [25.728339, -80.24083], description: "Mayfair House is Coconut Grove lushness: garden courtyards, sculptural architecture, rooftop pool, and a base that favors Grove restaurants and bay walks over beach traffic.", officialUrl: "https://www.mayfairhousemiami.com/", bookingUrl: "https://www.mayfairhousemiami.com/", photo: images.mayfair, hours: alwaysOpen, price: "$$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["boutique", "design", "romantic", "quiet", "coconut_grove"], editorialUrls: ["https://www.cntraveler.com/hotels/miami/mayfair-house-hotel-garden", "https://www.travelandleisure.com/mayfair-house-hotel-garden-miami-review-6755352"] }),
  stop({ id: "miami-hotel-citizenm", name: "citizenM Miami Brickell", coordinates: [25.763962, -80.193142], description: "citizenM Miami Brickell is the efficient base: compact rooms, strong beds, self-check-in, a rooftop pool, and immediate access to Brickell restaurants and transit. It is a sensible hotel for money left for food and bars, not a resort you will barely use.", officialUrl: "https://www.citizenm.com/hotels/united-states/miami/miami-brickell-hotel", bookingUrl: "https://www.citizenm.com/hotels/united-states/miami/miami-brickell-hotel", photo: images.citizenM, hours: alwaysOpen, price: "$$", priceSource: "Official booking site / Google Travel", venueKind: "lodging", lodgingType: "hotel", attributeTags: ["midrange", "work_friendly", "central", "transit_friendly", "design"], editorialUrls: ["https://www.cntraveler.com/hotels/miami/citizenm-miami-brickell", "https://www.miamiandbeaches.com/l/hotels/citizenm-miami-brickell/49344"] }),
];

const hostelStops = [
  stop({ id: "miami-hostel-viajero", name: "Viajero Miami", coordinates: [25.780994, -80.131323], description: "Viajero Miami has shared and private rooms, a pool, social programming, and a South Beach location close to the sand. Exact room inventory changes, so dorm versus private availability should be confirmed at booking.", officialUrl: "https://www.viajerohostels.com/destinations/miami/", bookingUrl: "https://www.viajerohostels.com/destinations/miami/", photo: images.viajero, hours: alwaysOpen, price: "$$", priceSource: "Official booking site / Hostelworld", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "social", "beach", "private_rooms", "dorms"], editorialUrls: ["https://www.hostelworld.com/hostels/p/308226/viajero-miami/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-beds-drinks", name: "Beds n' Drinks", coordinates: [25.790879, -80.130801], description: "Beds n' Drinks is a straightforward budget hostel near Lincoln Road and the beach, useful for travelers who care more about location and cost than polished design.", officialUrl: "https://bedsndrinks.com/", bookingUrl: "https://bedsndrinks.com/", photo: images.bedsDrinks, hours: alwaysOpen, price: "$", priceSource: "Official booking site / Hostelworld", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "social", "beach", "dorms", "private_rooms"], editorialUrls: ["https://www.hostelworld.com/hostels/p/72528/beds-n-drinks/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-posh", name: "Posh South Beach Hostel", coordinates: [25.778342, -80.132023], description: "Posh South Beach is an adults-only hostel with dorm beds and a rooftop pool near the beach. Its social, party-adjacent atmosphere suits a livelier stay better than a quiet retreat.", officialUrl: "https://www.poshsouthbeach.com/", bookingUrl: "https://www.poshsouthbeach.com/", photo: images.posh, hours: alwaysOpen, price: "$", priceSource: "Official booking site / Hostelworld", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "party", "beach", "dorms", "social"], editorialUrls: ["https://www.hostelworld.com/hostels/p/73684/posh-south-beach-hostel/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-bikini", name: "Bikini Hostel & Beer Garden", coordinates: [25.789478, -80.140664], description: "Bikini Hostel is a rougher, budget-social South Beach hostel with shared rooms, private-room possibilities, and a beer-garden format that will not suit every traveler. Include it only for price-sensitive guests who have read current reviews and understand the tradeoff between cost, social energy, and comfort.", officialUrl: "https://bikinihostel.com/", bookingUrl: "https://bikinihostel.com/", photo: images.bikini, hours: alwaysOpen, price: "$", priceSource: "Official booking site / Hostelworld", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "social", "party", "dorms", "no_frills"], editorialUrls: ["https://www.hostelworld.com/hostels/p/53831/bikini-hostel-and-beer-garden/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-freehand", name: "Freehand Miami", coordinates: [25.80338, -80.126593], description: "Freehand Miami is a social budget hotel and hostel hybrid with shared and private rooms, a leafy courtyard, a busy bar, and a Mid-Beach location.", officialUrl: "https://freehandhotels.com/miami/", bookingUrl: "https://freehandhotels.com/miami/", photo: images.freehand, hours: alwaysOpen, price: "$$", priceSource: "Official booking site / Hostelworld / Google Travel", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "social", "beach", "private_rooms", "nightlife_nearby"], editorialUrls: ["https://www.hostelworld.com/hostels/p/61189/freehand-miami/", "https://www.timeout.com/miami/hotels/freehand-miami"] }),
  stop({ id: "miami-hostel-south-beach-rooms", name: "South Beach Rooms and Hostel", coordinates: [25.77955, -80.132454], description: "South Beach Rooms and Hostel is a pure location/value hostel near Ocean Drive, better for cheap access than anyone chasing design or quiet.", officialUrl: "https://southbeachroomsandhostel.com/", bookingUrl: "https://southbeachroomsandhostel.com/", photo: images.southBeachRooms, hours: alwaysOpen, price: "$", priceSource: "Official booking site / Hostelworld", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "beach", "dorms", "private_rooms", "no_frills"], editorialUrls: ["https://www.hostelworld.com/hostels/p/19386/south-beach-rooms-and-hostel/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-generator", name: "Generator Miami", coordinates: [25.80703, -80.12386], description: "Generator Miami pairs Mid-Beach access with private rooms, shared rooms, a pool, and active common spaces. It feels closer to a budget hotel with hostel social life, allowing groups with different comfort levels to stay together near the beach.", officialUrl: "https://staygenerator.com/hostels/miami/", bookingUrl: "https://staygenerator.com/hostels/miami/", photo: images.generatorMiami, hours: { default: "Property page lists date-specific check-in, reception, restaurant, and bar details." }, price: "$$", priceSource: "Official booking site / Hostelworld / Google Travel", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "design", "beach", "private_rooms", "social"], editorialUrls: ["https://www.gq.com/story/generator-miami-luxury-hostel-wave", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-casa-rosa", name: "Casa Rosa All Women's Hostel Miami", coordinates: [25.82048, -80.195566], description: "Casa Rosa is a women-only hostel near the Design District with dorms, a shared kitchen, and a co-living atmosphere away from South Beach. The lower price preserves access to Midtown, Wynwood, and the Design District.", officialUrl: "https://www.hostelworld.com/hostels/p/308490/casa-rosa-all-women-s-hostel-miami/", bookingUrl: "https://www.hostelworld.com/hostels/p/308490/casa-rosa-all-women-s-hostel-miami/", photo: images.casaRosa, hours: { default: "Hostelworld property data lists check-in from 3:00 PM, check-out before 11:00 AM, and reception details." }, price: "$", priceSource: "Hostelworld / Google Travel", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "women_only", "co_living", "design_district", "kitchen"], editorialUrls: ["https://www.hostelworld.com/hostels/north-america/usa/miami/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
  stop({ id: "miami-hostel-island-house", name: "Island House South Beach", coordinates: [25.786396, -80.130928], description: "Island House South Beach is a restored Art Deco budget stay on Collins Avenue, closer to guesthouse than classic dorm hostel but still listed in the hostel ecosystem for price-sensitive travelers. Include it for central South Beach, breakfast-included value, and private-room calm without paying full boutique-hotel rates.", officialUrl: "https://www.hostelworld.com/hostels/p/21058/island-house-south-beach/", bookingUrl: "https://www.hostelworld.com/hostels/p/21058/island-house-south-beach/", photo: images.islandHouse, hours: { default: "Hostelworld property data lists check-in from 3:00 PM, check-out before 11:00 AM, and 24-hour reception." }, price: "$$", priceSource: "Hostelworld / Hotels.com / Google Travel", venueKind: "lodging", lodgingType: "guesthouse", attributeTags: ["budget", "private_rooms", "art_deco", "south_beach", "breakfast"], editorialUrls: ["https://www.hostelworld.com/hostels/north-america/usa/miami/", "https://www.hotels.com/ho221006/island-house-south-beach-miami-beach-united-states-of-america/"] }),
  stop({ id: "miami-hostel-utopia-aventura", name: "Utopia Hostel Miami Aventura", coordinates: [25.960397, -80.149565], description: "Utopia Hostel Miami Aventura provides lower-cost beds and a shared kitchen on Miami's north side. The location suits Aventura, Sunny Isles, northern beaches, and road trips far better than nightlife centered on South Beach.", officialUrl: "https://www.hostelworld.com/hostels/p/335257/utopia-hostel-miami-aventura/", bookingUrl: "https://www.hostelworld.com/hostels/p/335257/utopia-hostel-miami-aventura/", photo: images.utopia, hours: { default: "Hostelworld property data lists check-in from 4:00 PM to 11:00 PM and check-out before 11:00 AM." }, price: "$", priceSource: "Hostelworld / Google Travel", venueKind: "lodging", lodgingType: "hostel", attributeTags: ["budget", "aventura", "north_miami", "social", "kitchen"], editorialUrls: ["https://www.hostelworld.com/hostels/north-america/usa/miami/", "https://www.booking.com/hostels/city/us/miami-beach.html"] }),
];

const casualBarStops = [
  stop({ id: "miami-bar-club-deuce", name: "Mac's Club Deuce", coordinates: [25.785566, -80.134073], description: "Mac's Club Deuce keeps South Beach dive-bar mythology intact through old neon, a pool table, an early happy hour, and a crowd untouched by bottle-service expectations. It remains one of the few beach bars that feels genuinely lived in.", officialUrl: "https://www.macsclubdeuce.com/", photo: images.clubDeuce, hours: daily("late-morning to very late bar hours; verify same-day hours before relying on late service."), price: "$", priceSource: "Official/site listing / Google Maps", venueKind: "nightlife", nightlifeType: "dive_bar", attributeTags: ["dive_bar", "cheap_drinks", "late_night", "local_bar", "south_beach"], editorialUrls: ["https://www.timeout.com/miami/bars/macs-club-deuce", "https://miami.eater.com/maps/best-bars-miami"] }),
  stop({ id: "miami-bar-zeyzey", name: "ZeyZey", coordinates: [25.83248, -80.19228], description: "ZeyZey runs live shows and DJ nights in a tropical Little Haiti courtyard with food vendors and a crowd closer to Miami's creative scene than its bottle-service circuit. Check the lineup first because the event changes the room.", officialUrl: "https://zeyzeymiami.com/", photo: images.zeyzey, hours: { default: "Tuesday-Sunday evening to late; use the official calendar and Instagram for opening times and show times." }, price: "$$", priceSource: "Official calendar / Google Maps", venueKind: "nightlife", nightlifeType: "live_music_venue", musicGenres: ["dj", "live_events", "global"], attributeTags: ["live_music", "dj_sets", "casual_nightlife", "little_haiti", "outdoor"], editorialUrls: ["https://miami.eater.com/venue/103380/zeyzey", "https://www.timeout.com/miami/music/zeyzey"] }),
  stop({ id: "miami-bar-ball-chain", name: "Ball & Chain", coordinates: [25.765092, -80.219605], description: "Ball & Chain gives Little Havana a night out with live Latin music, mojitos, salsa energy, and a historic Calle Ocho name that still pulls visitors and locals into the same room.", officialUrl: "https://ballandchainmiami.com/", photo: images.ballChain, hours: daily("afternoon/evening through late-night service; live music schedules vary and should be checked."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "live_music_venue", musicGenres: ["latin", "salsa", "son"], attributeTags: ["live_music", "dance_floor", "lively_nightlife", "little_havana", "tourist_friendly"], editorialUrls: ["https://www.timeout.com/miami/bars/ball-chain", "https://www.miamiandbeaches.com/l/eat-and-drink/ball-chain/3742"] }),
  stop({ id: "miami-bar-churchills", name: "Churchill's Pub", coordinates: [25.826744, -80.191056], description: "Churchill's is the Little Haiti punk-and-pub institution, rough around the edges in a way that Miami needs if the nightlife map is not going to be only rooftops. Go for local music, beer, and grit; check the event calendar because the best reason to go is usually the bill.", officialUrl: "https://www.churchillspub.com/", photo: images.churchills, hours: { default: "Pub and show hours vary by event; use the official calendar and current listing before going." }, price: "$", priceSource: "Official calendar / Google Maps", venueKind: "nightlife", nightlifeType: "live_music_venue", musicGenres: ["punk", "rock", "local_bands"], attributeTags: ["live_music", "cheap_drinks", "casual_nightlife", "little_haiti", "late_night"], editorialUrls: ["https://www.timeout.com/miami/music/churchills-pub", "https://miami.eater.com/maps/best-bars-miami"] }),
  stop({ id: "miami-bar-lost-boy", name: "Lost Boy Dry Goods", coordinates: [25.775435, -80.190999], description: "Lost Boy is the Downtown bar that feels more like a neighborhood room than a nightlife pitch deck: darts, pints, cocktails, and a pub-ish rhythm in a city that can over-style everything.", officialUrl: "https://lostboydrygoods.com/", photo: images.lostBoy, hours: daily("afternoon through late-night bar hours; verify current hours before going."), price: "$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "pub", attributeTags: ["local_bar", "casual_nightlife", "games", "downtown", "walk_in_friendly_nightlife"], editorialUrls: ["https://miami.eater.com/maps/best-bars-miami", "https://www.timeout.com/miami/bars/lost-boy"] }),
  stop({ id: "miami-bar-mama-tried", name: "Mama Tried", coordinates: [25.773959, -80.192717], description: "Mama Tried is Downtown's neon-lit, late-running party bar without the full club commitment: DJs, cheap-ish drinks, booths, and a crowd that can turn quickly from casual to messy.", officialUrl: "https://mamatriedmia.com/", photo: images.mamaTried, hours: { default: "Evening to late-night hours vary by day; use current schedule before planning around a late stop; official page controls the posted schedule." }, price: "$$", priceSource: "Official/menu listing / Google Maps", venueKind: "nightlife", nightlifeType: "dive_bar", musicGenres: ["dj", "dance"], attributeTags: ["late_night", "dj_sets", "casual_nightlife", "downtown", "party_nightlife"], editorialUrls: ["https://www.timeout.com/miami/bars/mama-tried", "https://miami.eater.com/maps/best-bars-miami"] }),
  stop({ id: "miami-bar-bobs-your-uncle", name: "Bob's Your Uncle", coordinates: [25.85556, -80.12309], description: "Bob's Your Uncle is a North Beach neighborhood bar with darts, pool, local beer, late hours, and an easier crowd than South Beach's busiest rooms. Its local-bar character sits well north of the tourist strip.", officialUrl: "https://www.bobsyourunclemiami.com/", photo: images.bobsYourUncle, hours: { default: "Sunday-Thursday 3:00 PM-2:00 AM; Friday-Saturday 3:00 PM-3:00 AM." }, price: "$$", priceSource: "Official site / Miami Beach listing", venueKind: "nightlife", nightlifeType: "pub", attributeTags: ["local_bar", "games", "casual_nightlife", "north_beach", "late_night"], editorialUrls: ["https://www.timeout.com/miami/bars/bobs-your-uncle", "https://www.experiencemiamibeach.com/businesses/bobs-your-uncle"] }),
  stop({ id: "miami-bar-teds", name: "Ted's Hideaway", coordinates: [25.770193, -80.134318], description: "Expect regulars, screens, and late hours rather than design; that plainness is exactly why it is useful.", officialUrl: "https://tedshideaway.com/", photo: images.tedHideaway, hours: daily("afternoon through late-night bar hours; verify holiday and game-day schedules."), price: "$", priceSource: "Official/site listing / Google Maps", venueKind: "nightlife", nightlifeType: "dive_bar", attributeTags: ["sports_screening", "cheap_drinks", "late_night", "south_beach", "local_bar"], editorialUrls: ["https://www.timeout.com/miami/bars/teds-hideaway", "https://www.theinfatuation.com/miami/reviews/teds-hideaway"] }),
  stop({ id: "miami-bar-corner", name: "The Corner", coordinates: [25.78382, -80.1941], description: "The Corner is Downtown Miami's late-night pressure valve: craft drinks, beer, DJs, jazz nights, karaoke, and food until the hour when most polished bars have already given up.", officialUrl: "https://www.thecornermiami.com/", photo: images.corner, hours: { default: "Sunday-Thursday 4:00 PM-5:00 AM; Friday-Saturday 4:00 PM-7:00 AM." }, price: "$$", priceSource: "Official site / Eater Miami", venueKind: "nightlife", nightlifeType: "cocktail_bar", musicGenres: ["dj", "jazz", "karaoke"], attributeTags: ["late_night", "casual_nightlife", "downtown", "local_bar", "food_bar"], editorialUrls: ["https://miami.eater.com/venue/32240/the-corner", "https://miami.eater.com/maps/best-neighborhood-bars-miami"] }),
  stop({ id: "miami-bar-doms", name: "DOM'S Brickell", coordinates: [25.762435, -80.193444], description: "DOM'S is a casual Brickell lounge for well-made drinks, DJ nights, and groups that want to stay late without committing to a full club. The atmosphere is relaxed by neighborhood standards.", officialUrl: "https://www.dombrickell.com/", photo: images.doms, hours: { default: "Evening and late-night hours vary by day; use the current calendar before going; official page controls the posted schedule." }, price: "$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "lounge", musicGenres: ["dj"], attributeTags: ["brickell", "dj_sets", "late_night", "casual_nightlife", "group_friendly"], editorialUrls: ["https://www.timeout.com/miami/bars/doms-brickell", "https://miami.eater.com/maps/best-bars-miami"] }),
];
...
const cocktailStops = [
  ...
  stop({ id: "miami-cocktail-sweet-liberty", name: "Sweet Liberty Drinks & Supply Co.", coordinates: [25.793537, -80.13241], description: "Sweet Liberty handles serious cocktails, loud groups, oysters, dancing, and late-night energy without turning into a velvet-rope parody. The decorated Miami Beach room remains technically sharp and genuinely fun.", officialUrl: "https://www.mysweetliberty.com/", photo: images.sweetLiberty, hours: daily("afternoon/evening through late-night service; verify same-day hours and kitchen times."), price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", musicGenres: ["dj"], attributeTags: ["craft_cocktails", "late_night", "lively_nightlife", "dance_floor", "beach"], editorialUrls: ["https://www.theworlds50best.com/bars/the-list/sweet-liberty.html", "https://miami.eater.com/maps/best-bars-miami"] }),
  stop({ id: "miami-cocktail-cafe-la-trova", name: "Cafe La Trova", coordinates: [25.765106, -80.211275], description: "Cafe La Trova brings Little Havana cantinero tradition together with rum drinks, croquetas, live music, and a room that can move from dinner to dancing without changing buildings. This is Miami hospitality at full volume, not a quiet speakeasy.", officialUrl: "https://cafelatrova.com/", photo: images.cafeLaTrova, hours: daily("lunch/dinner through late-night bar service; live music and back-room schedules vary."), price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", musicGenres: ["latin", "son", "salsa"], attributeTags: ["craft_cocktails", "live_music", "dance_floor", "little_havana", "lively_nightlife"], editorialUrls: ["https://www.theworlds50best.com/bars/the-list/cafe-la-trova.html", "https://www.timeout.com/miami/bars/cafe-la-trova"] }),
  stop({ id: "miami-cocktail-swizzle", name: "Swizzle Rum Bar & Drinkery", coordinates: [25.781777, -80.132585], description: "Swizzle is a small, moody South Beach basement bar specializing in rum and carefully made cocktails. The intimate room suits focused drinking and small parties better than a large group.", officialUrl: "https://www.swizzlerumbarmiami.com/", photo: images.swizzle, hours: { default: "Evening and late-night hours vary by day; use current schedule before going; official page controls the posted schedule." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", attributeTags: ["craft_cocktails", "speakeasy", "rum", "date_night", "south_beach"], editorialUrls: ["https://www.timeout.com/miami/bars/swizzle-rum-bar-drinkery", "https://www.theinfatuation.com/miami/reviews/swizzle-rum-bar-drinkery"] }),
  stop({ id: "miami-cocktail-viceversa", name: "ViceVersa", coordinates: [25.778391, -80.189039], description: "ViceVersa gives Downtown Miami an Italian aperitivo bar with serious cocktail credentials: negronis, martinis, raw bar plates, pizza, and a polished lobby setting at the Elser Hotel.", officialUrl: "https://viceversamia.com/", photo: images.viceVersa, hours: hours.viceVersa, price: "$$$", priceSource: "Official site / Eater Miami", venueKind: "nightlife", nightlifeType: "cocktail_bar", attributeTags: ["craft_cocktails", "aperitivo", "downtown", "food_bar", "date_night"], editorialUrls: ["https://viceversamia.com/", "https://miami.eater.com/2024/6/20/24182466/vice-versa-miami-now-open"] }),
  stop({ id: "miami-cocktail-kaiju", name: "Kaiju", coordinates: [25.771082, -80.192706], description: "Kaiju is the Downtown hidden-cocktail move for people who like a little weirdness with their drink: anime references, a small room, and cocktails that feel more personal than hotel-bar safe.", officialUrl: "https://www.kaijumiami.com/", photo: images.kaiju, hours: { default: "Evening cocktail hours vary by day; use official page hours before going." }, price: "$$$", priceSource: "Official/menu listing / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", attributeTags: ["craft_cocktails", "speakeasy", "downtown", "date_night", "small_group"], editorialUrls: ["https://www.timeout.com/miami/bars/kaiju", "https://miami.eater.com/maps/best-bars-miami"] }),
  stop({ id: "miami-cocktail-medium-cool", name: "Medium Cool", coordinates: [25.793624, -80.130555], description: "Medium Cool is a Miami Beach listening-room cocktail bar built around vinyl, dim light, intimate pace, and a scale well below a full club. Event programming changes by date.", officialUrl: "https://www.mediumcoolmiami.com/", photo: images.mediumCool, hours: { default: "Evening and late-night hours vary by event and day; use current schedule before going; official page controls the posted schedule." }, price: "$$$", priceSource: "Official/menu listing / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", musicGenres: ["vinyl", "dj"], attributeTags: ["craft_cocktails", "dj_sets", "date_night", "low_key_nightlife", "south_beach"], editorialUrls: ["https://www.timeout.com/miami/bars/medium-cool", "https://www.theinfatuation.com/miami/reviews/medium-cool"] }),
  stop({ id: "miami-cocktail-stormy-monday", name: "Stormy Monday", coordinates: [25.779376, -80.140827], description: "Stormy Monday is an intimate South Beach bar with warm service, soulful music, serious drinks, and shareable small plates in the former Macchialina space on Alton Road. Neighborhood scale replaces rooftop or hotel-lounge spectacle.", officialUrl: "https://www.instagram.com/stormymondaymia/", photo: images.stormyMonday, hours: hours.stormyMonday, price: "$$", priceSource: "OpenTable / local listings", venueKind: "nightlife", nightlifeType: "cocktail_bar", musicGenres: ["soul", "live_music"], attributeTags: ["craft_cocktails", "live_music", "south_beach", "date_night", "low_key_nightlife"], editorialUrls: ["https://www.opentable.com/r/stormy-monday-bar-miami-beach", "https://www.theinfatuation.com/miami/reviews/stormy-monday"] }),
  stop({ id: "miami-cocktail-dantes", name: "Dante's HiFi", coordinates: [25.800907, -80.199371], description: "Dante's HiFi is Wynwood's vinyl listening bar, more about sound, mood, and a controlled room than a sprawling bar crawl.", officialUrl: "https://www.danteshifi.com/", photo: images.dantes, hours: { default: "Listening-room hours and ticketed sessions vary by night; use the official calendar." }, price: "$$$", priceSource: "Official calendar / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", musicGenres: ["vinyl", "dj"], attributeTags: ["dj_sets", "craft_cocktails", "reservation_recommended_nightlife", "wynwood", "date_night"], editorialUrls: ["https://www.timeout.com/miami/bars/dantes-hifi", "https://miami.eater.com/maps/best-bars-miami"] }),
  stop({ id: "miami-cocktail-champagne-bar", name: "The Champagne Bar at The Surf Club", coordinates: [25.878197, -80.121615], description: "The Champagne Bar at The Surf Club pairs terrazzo interiors and the property's 1930s social history with Champagne and precisely made cocktails. It is formal and expensive; dress and budget accordingly.", officialUrl: "https://www.fourseasons.com/surfside/dining/lounges/the_champagne_bar/", photo: images.champagneBar, hours: { default: "Bar hours vary by day and hotel schedule; use the Four Seasons dining page before going; official page controls the posted schedule." }, price: "$$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", attributeTags: ["luxury", "romantic_nightlife", "craft_cocktails", "dressy", "historic"], editorialUrls: ["https://www.timeout.com/miami/bars/champagne-bar", "https://www.forbestravelguide.com/restaurants/miami-florida/the-champagne-bar"] }),
  stop({ id: "miami-cocktail-sugar", name: "Sugar", coordinates: [25.767478, -80.193598], description: "Sugar is a garden-like Brickell rooftop bar with high skyline views above the neighborhood's mall-and-office grid. The popular room observes a dress code, and weather or private events can alter service.", officialUrl: "https://www.sugar-miami.com/", photo: images.sugar, hours: { default: "Evening rooftop hours vary by day, weather, and private events; use before going." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "rooftop_bar", attributeTags: ["scenic_nightlife", "rooftop", "dressy", "brickell", "reservation_recommended_nightlife"], editorialUrls: ["https://www.timeout.com/miami/bars/sugar", "https://miami.eater.com/maps/best-rooftop-bars-miami"] }),
];

const cultureStops = [
  stop({ id: "miami-culture-art-deco", name: "Art Deco Historic District", coordinates: [25.780955, -80.131637], description: "The Art Deco Historic District is a historic district that explains why South Beach looks like South Beach: pastel facades, nautical lines, neon, and a preservation story hiding under the party surface. Go early or golden hour, then use the museum or a walking tour to keep it from becoming only a photo walk.", officialUrl: "https://mdpl.org/", photo: images.artDeco, hours: daily("district access; museum and guided-tour hours vary by day, so verify the Miami Design Preservation League schedule."), venueKind: "culture", subcategory: "historic_district", attributeTags: ["architecture", "walking", "historic", "south_beach", "free_entry"], editorialUrls: ["https://www.miamiandbeaches.com/things-to-do/history-and-heritage/art-deco-historic-district", "https://www.timeout.com/miami/things-to-do/art-deco-historic-district"] }),
  stop({ id: "miami-culture-pamm", name: "Perez Art Museum Miami", coordinates: [25.786034, -80.186193], description: "PAMM presents contemporary art in a bayfront Herzog & de Meuron building with hanging gardens and shaded terraces that pull the waterfront into the visit.", officialUrl: "https://www.pamm.org/", photo: images.pamm, hours: { default: "Museum hours vary by weekday, weekend, and events; use the official hours page before visiting; official page controls the posted schedule." }, venueKind: "culture", subcategory: "museum", attributeTags: ["museum", "art", "bayfront", "indoor", "family_friendly"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/perez-art-museum-miami-pamm/3170", "https://www.timeout.com/miami/museums/perez-art-museum-miami"] }),
  stop({ id: "miami-culture-frost", name: "Phillip and Patricia Frost Museum of Science", coordinates: [25.785986, -80.187785], description: "Frost Science combines a planetarium, multilevel aquarium, and hands-on science exhibits in an indoor Museum Park complex. The breadth works especially well for families and humid or stormy afternoons.", officialUrl: "https://www.frostscience.org/", photo: images.frost, hours: daily("museum hours; planetarium shows, holidays, and special events should be checked before booking."), venueKind: "culture", subcategory: "science_museum", attributeTags: ["museum", "family_friendly", "indoor", "downtown", "tickets_required"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/phillip-and-patricia-frost-museum-of-science/3298", "https://www.timeout.com/miami/museums/frost-science"] }),
  stop({ id: "miami-culture-vizcaya", name: "Vizcaya Museum and Gardens", coordinates: [25.744452, -80.210166], description: "Vizcaya is Miami's most transportive historic house: bayfront gardens, Mediterranean Revival fantasy, coral-stone texture, and a Gilded Age story that feels strange in the subtropics.", officialUrl: "https://vizcaya.org/", photo: images.vizcaya, hours: { default: "Museum and garden hours vary by day, with closures and ticketing windows posted officially; use before visiting; official page controls the posted schedule." }, venueKind: "culture", subcategory: "historic_house", attributeTags: ["museum", "gardens", "historic", "scenic", "tickets_required"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/vizcaya-museum-and-gardens/1432", "https://www.timeout.com/miami/museums/vizcaya-museum-gardens"] }),
  stop({ id: "miami-culture-wynwood-walls", name: "Wynwood Walls", coordinates: [25.801077, -80.199206], description: "Wynwood Walls is touristy because it works: a concentrated, ticketed street-art park that gives structure to a neighborhood whose murals now spread far beyond it.", officialUrl: "https://thewynwoodwalls.com/", photo: images.wynwoodWalls, hours: daily("ticketed daytime/evening hours; special event closures should be checked before visiting."), venueKind: "culture", subcategory: "street_art", attributeTags: ["street_art", "tickets_required", "wynwood", "walking", "family_friendly"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/wynwood-walls/2515", "https://www.timeout.com/miami/things-to-do/wynwood-walls"] }),
  stop({ id: "miami-culture-rubell", name: "Rubell Museum", coordinates: [25.802803, -80.204331], description: "Rubell Museum gives Miami a serious private-collection stop in Allapattah, with large-scale contemporary work and a calmer alternative to the Wynwood churn.", officialUrl: "https://rubellmuseum.org/miami", photo: images.rubell, hours: { default: "Museum hours and closed days vary seasonally; use the official Miami hours page before visiting." }, venueKind: "culture", subcategory: "museum", attributeTags: ["museum", "contemporary_art", "indoor", "allapattah", "tickets_required"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/rubell-museum/43463", "https://www.timeout.com/miami/museums/rubell-museum"] }),
  stop({ id: "miami-culture-ica", name: "Institute of Contemporary Art, Miami", coordinates: [25.814371, -80.194068], description: "ICA Miami is a Design District that keeps the neighborhood from being only shopping: free admission, contemporary exhibitions, and a sculpture garden that rewards a slower pass.", officialUrl: "https://icamiami.org/", photo: images.ica, hours: { default: "Gallery hours vary by day, with timed-entry and closure notes posted officially; use before visiting; official page controls the posted schedule." }, venueKind: "culture", subcategory: "museum", attributeTags: ["museum", "contemporary_art", "free_entry", "design_district", "indoor"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/institute-of-contemporary-art-miami/4344", "https://www.timeout.com/miami/museums/institute-of-contemporary-art-miami"] }),
  stop({ id: "miami-culture-historymiami", name: "HistoryMiami Museum", coordinates: [25.774438, -80.196018], description: "HistoryMiami is a downtown museum, useful when the city feels like only beaches, clubs, and real estate.", officialUrl: "https://historymiami.org/", photo: images.historyMiami, hours: { default: "Museum hours vary by day and exhibitions; use the official visit page before going; official page controls the posted schedule." }, venueKind: "culture", subcategory: "history_museum", attributeTags: ["museum", "history", "downtown", "indoor", "family_friendly"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/historymiami-museum/2168", "https://www.timeout.com/miami/museums/historymiami"] }),
  stop({ id: "miami-culture-calle-ocho", name: "Calle Ocho / Little Havana", coordinates: [25.765339, -80.219988], description: "Calle Ocho is a Cuban-American public corridor of ventanitas, domino tables, cigar shops, murals, restaurants, and live music. It expresses one community's history and daily life rather than standing in for every Latin culture in Miami.", officialUrl: "https://www.miamiandbeaches.com/neighborhoods/little-havana", photo: images.calleOcho, hours: daily("neighborhood access; individual shops, bars, and cultural venues keep separate hours."), venueKind: "culture", subcategory: "neighborhood", attributeTags: ["walking", "little_havana", "food", "music", "free_entry"], editorialUrls: ["https://www.miamiandbeaches.com/neighborhoods/little-havana", "https://www.timeout.com/miami/things-to-do/little-havana"] }),
  stop({ id: "miami-culture-arsht", name: "Adrienne Arsht Center", coordinates: [25.787685, -80.189479], description: "The Arsht Center is a performing-arts venue that keeps Miami culture from being only museums and murals: touring Broadway, classical music, dance, jazz, and local programming in one downtown campus. Check the calendar first; the building matters, but the right show is the reason to go.", officialUrl: "https://www.arshtcenter.org/", photo: images.arsht, hours: { default: "Performance, box office, and lobby hours vary by event; use the official calendar before planning." }, venueKind: "event_venue", subcategory: "performing_arts", attributeTags: ["performing_arts", "theatre_show", "music", "downtown", "tickets_required"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/adrienne-arsht-center-for-the-performing-arts/1994", "https://www.timeout.com/miami/theater/adrienne-arsht-center"] }),
];

const activityStops = [
  stop({ id: "miami-activity-south-beach", name: "South Beach", coordinates: [25.782612, -80.134077], description: "South Beach combines broad sand, warm water, swimmers, and Art Deco hotels with Miami performing at full volume behind the dunes. Early hours reveal the beach before crowds build; Ocean Drive and Lincoln Road take over later.", officialUrl: "https://www.miamiandbeaches.com/neighborhoods/south-beach", photo: images.southBeach, hours: daily("public beach access, with lifeguard and facility hours varying by area; check beach conditions before swimming."), venueKind: "outdoors", subcategory: "beach", attributeTags: ["beach", "free_entry", "family_friendly", "south_beach", "walking"], editorialUrls: ["https://www.miamiandbeaches.com/neighborhoods/south-beach", "https://www.timeout.com/miami/things-to-do/south-beach"] }),
  ...
  stop({ id: "miami-activity-little-havana", name: "Little Havana", coordinates: [25.765339, -80.219988], description: "Little Havana makes Miami legible through Cuban food, music, politics, cigar shops, domino games, and strong coffee along and around Calle Ocho. Walk in daylight into early evening, eat at one or two places, and resist reducing a working neighborhood to a single selfie.", officialUrl: "https://www.miamiandbeaches.com/neighborhoods/little-havana", photo: images.calleOcho, hours: daily("neighborhood access, with individual restaurants, shops, and music venues keeping separate schedules."), venueKind: "culture", subcategory: "neighborhood_walk", attributeTags: ["walking", "little_havana", "food", "music", "free_entry"], editorialUrls: ["https://www.timeout.com/miami/things-to-do/little-havana", "https://www.miamiandbeaches.com/neighborhoods/little-havana"] }),
  stop({ id: "miami-activity-wynwood", name: "Wynwood Walls", coordinates: [25.801077, -80.199206], description: "Wynwood Walls presents large-scale murals by international street artists inside a ticketed outdoor complex. The curated site is only one piece of Wynwood, so continue through surrounding streets and local businesses for the neighborhood's broader mural culture.", officialUrl: "https://thewynwoodwalls.com/", photo: images.wynwoodWalls, hours: daily("ticketed daytime/evening hours; special event closures should be checked before visiting."), venueKind: "culture", subcategory: "street_art", attributeTags: ["street_art", "walking", "tickets_required", "wynwood", "family_friendly"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/wynwood-walls/2515", "https://www.timeout.com/miami/things-to-do/wynwood-walls"] }),
  stop({ id: "miami-activity-vizcaya", name: "Vizcaya Museum and Gardens", coordinates: [25.744452, -80.210166], description: "Vizcaya combines historic rooms, elaborate formal gardens, and bayfront stonework in a strange subtropical-European estate. Give the grounds real time and carry water in the heat; the gardens are as memorable as the house.", officialUrl: "https://vizcaya.org/", photo: images.vizcaya, hours: { default: "Museum and garden hours vary by day, with ticketing windows posted officially; use before visiting; official page controls the posted schedule." }, venueKind: "culture", subcategory: "historic_house", attributeTags: ["gardens", "museum", "historic", "tickets_required", "scenic"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/vizcaya-museum-and-gardens/1432", "https://www.timeout.com/miami/museums/vizcaya-museum-gardens"] }),
  stop({ id: "miami-activity-design-district", name: "Miami Design District", coordinates: [25.814771, -80.193659], description: "Miami Design District compresses luxury retail, public art, architecture, and dining into a walkable pocket far removed from the beach. ICA, window-shopping, lunch, and shaded passages reward accepting the polished mood rather than hunting for grit.", officialUrl: "https://www.miamidesigndistrict.com/", photo: images.designDistrict, hours: daily("District public realm is accessible daily; official district pages list store, gallery, restaurant, and museum schedules."), venueKind: "retail", subcategory: "district", attributeTags: ["design", "shopping", "architecture", "walking", "food"], editorialUrls: ["https://www.miamiandbeaches.com/neighborhoods/design-district", "https://www.timeout.com/miami/things-to-do/design-district"] }),
  stop({ id: "miami-activity-fairchild", name: "Fairchild Tropical Botanic Garden", coordinates: [25.67798, -80.274203], description: "Fairchild is a heat-aware nature botanic garden for palms, tropical fruit, orchids, water features, and a slower Miami that does not revolve around sand.", officialUrl: "https://fairchildgarden.org/", photo: images.fairchild, hours: daily("garden daytime hours; ticketed events and weather closures should be checked before visiting."), venueKind: "outdoors", subcategory: "botanic_garden", attributeTags: ["nature", "gardens", "family_friendly", "tickets_required", "quiet"], editorialUrls: ["https://www.miamiandbeaches.com/l/things-to-do/fairchild-tropical-botanic-garden/1126", "https://www.timeout.com/miami/things-to-do/fairchild-tropical-botanic-garden"] }),
  stop({ id: "miami-activity-venetian-pool", name: "Venetian Pool", coordinates: [25.746339, -80.271975], description: "Venetian Pool is a Coral Gables oddity worth planning around: a historic spring-fed public pool carved from a coral-rock quarry, with grottos and Mediterranean Revival details.", officialUrl: "https://www.coralgables.com/venetianpool", photo: images.venetianPool, hours: { default: "Seasonal public swim hours vary by date, weather, and maintenance; use official hours before going." }, venueKind: "outdoors", subcategory: "historic_pool", attributeTags: ["swimming", "historic", "family_friendly", "tickets_required", "coral_gables"], editorialUrls: ["https://www.miamiandbeaches.com/l/things-to-do/venetian-pool/1794", "https://www.timeout.com/miami/things-to-do/venetian-pool"] }),
...
export const miamiCitywideGuides: MapList[] = [
  ...
  guide("Nightlife", "list-miami-dive-bars-casual-bars", "miami-best-dive-bars-casual-bars", "best-dive-bars", "Dives & Late-Night Live Music", "Miami after dark also belongs to old bars, live music, patios, beer, DJs, and late rooms beyond clubs, hotel lounges, and bottle-service choreography.", casualBarStops, sources.casualBars, "Best Dive Bars and Casual Bars in Miami", "Miami dive and casual bar guide with South Beach institutions, Wynwood patios, Little Havana music, Downtown late rooms, and local pub energy."),
  guide("Nightlife", "list-miami-cocktail-bars", "miami-best-cocktail-bars", "best-cocktail-bars", "Elevated Drinks & Listening Bars", "Miami cocktails across award-winning rooms, rum bars, Little Havana cantinero tradition, listening bars, rooftops, and high-gloss hotels. Drinks, music, views, service, and room scale define the differences.", cocktailStops, sources.cocktails, "Best Cocktail Bars in Miami for Rum, Rooftops, Listening Rooms, and Beach Drinks", "Source-backed Miami cocktail guide with Broken Shaker, Sweet Liberty, Cafe La Trova, Swizzle, ViceVersa, Stormy Monday, rooftops, and hotel glamour."),
...
miamiCitywideGuides.push(buildNatureGuide({
  city: "Miami", country: "United States", continent: "North America",
  id: "list-miami-citywide-nature", slug: "miami-best-parks-and-nature-citywide", seoSlug: "best-parks-and-nature",
  seoTitle: "Best Parks and Nature in Miami", seoDescription: "Miami nature guide to Everglades, Biscayne Bay, tropical gardens, hardwood hammocks, mangroves, beaches, and coastal parks.",
  title: "Mangrove Water, Tropical Hammocks, and Reef Horizons",
  description: "Miami’s nature is amphibious: Everglades sawgrass, Biscayne reef, mangrove tunnels, hardwood hammocks, tropical gardens, and Atlantic beaches share one subtropical system. Heat, storms, mosquitoes, tides, and long drives determine the honest version of each outing.",
  createdAt: "2026-07-29T00:00:00.000Z", checkedAt: "2026-08-04",
  sources: [
    { name: "Top organic result: Greater Miami parks and recreation", url: "https://www.miamiandbeaches.com/things-to-do/parks-recreation" },
    { name: "City of Miami natural areas", url: "https://www.miami.gov/My-Government/Departments/Parks-and-Recreation/City-of-Miami-Natural-Areas" },
    { name: "National Park Service South Florida", url: "https://www.nps.gov/ever/index.htm" },
    { name: "Google Maps - Miami parks and nature", url: "https://www.google.com/maps/search/best+parks+and+nature+Miami" },
  ],
  stops: [
    { id: "miami-nature-shark-valley", name: "Shark Valley", coordinates: [25.757, -80.766], description: "Shark Valley enters the Everglades through a flat fifteen-mile loop of sawgrass, alligators, wading birds, and an observation tower. Cycling and tram tours reduce uncertainty, while heat, lightning, and almost no shade punish poor timing.", hours: { default: "Daily 8:30 AM–6:00 PM; visitor center 9:00 AM–5:00 PM." }, officialUrl: "https://www.nps.gov/ever/planyourvisit/visitorcenters.htm", subcategory: "everglades_trail", attributeTags: ["wetland", "wildlife", "cycling", "tram", "day_trip"] },
    { id: "miami-nature-biscayne", name: "Biscayne National Park", coordinates: [25.4824, -80.2083], description: "Biscayne National Park is mostly water, protecting mangrove shore, shallow bay, coral reef, shipwrecks, and keys south of Miami. Boat, snorkel, and paddle plans depend on weather and operators; the mainland visitor center reveals only a fraction.", hours: { default: "Navigable waters are open 24 hours daily; Convoy Point grounds are open daily 7:00 AM–5:30 PM." }, officialUrl: "https://www.nps.gov/bisc/planyourvisit/accessibility.htm", subcategory: "marine_national_park", attributeTags: ["reef", "snorkeling", "boating", "mangrove", "day_trip"] },
    { id: "miami-nature-fairchild", name: "Fairchild Tropical Botanic Garden", coordinates: [25.677, -80.275], description: "Fairchild holds palms, cycads, tropical fruit, rainforest planting, butterfly habitat, and serious conservation collections across a large Coral Gables estate. Shade is partial, so summer visits need the same heat strategy as a trail.", hours: { default: "Daily 10:00 AM–5:00 PM; closed December 25." }, officialUrl: "https://fairchildgarden.org/", subcategory: "tropical_botanical_garden", attributeTags: ["garden", "tropical_plants", "butterflies", "ticketed", "family_friendly"] },
    { id: "miami-nature-matheson", name: "Matheson Hammock Park", coordinates: [25.68, -80.259], description: "Matheson Hammock combines mangrove shore, hardwood hammock, marina, trails, and a tidal atoll pool facing Biscayne Bay. Water quality, tide, and storm recovery can affect swimming even when the wooded park remains open.", hours: { default: "Daily sunrise–sunset on the official calendar." }, officialUrl: "https://www.miamidade.gov/parks/matheson-hammock.asp", subcategory: "coastal_hammock_park", attributeTags: ["mangrove", "beach", "walking", "picnic", "family_friendly"] },
    { id: "miami-nature-bill-baggs", name: "Bill Baggs Cape Florida State Park", coordinates: [25.669, -80.157], description: "Bill Baggs protects Atlantic beach, dunes, mangrove, coastal hammock, fishing shore, and the Cape Florida lighthouse at Key Biscayne’s southern end. Weekend entry can close at capacity, while currents and weather govern safe water use.", hours: { default: "Daily 8:00 AM–sunset." }, officialUrl: "https://www.floridastateparks.org/parks-and-trails/bill-baggs-cape-florida-state-park", subcategory: "coastal_state_park", attributeTags: ["beach", "lighthouse", "mangrove", "cycling", "capacity_limited"] },
    { id: "miami-nature-oleta", name: "Oleta River State Park", coordinates: [25.925, -80.145], description: "Oleta River State Park threads mangrove creeks, paddling water, mountain-bike trails, hammock forest, and a calm swimming beach through North Miami. Rentals and trail conditions follow weather, while mosquitoes thrive away from the bay breeze.", hours: { default: "Daily 8:00 AM–sundown." }, officialUrl: "https://www.floridastateparks.org/parks-and-trails/oleta-river-state-park/hours-fees", subcategory: "mangrove_state_park", attributeTags: ["kayaking", "mangrove", "mountain_biking", "beach", "rental"] },
    { id: "miami-nature-crandon", name: "Crandon Park", coordinates: [25.708, -80.155], description: "Crandon Park offers a broad Key Biscayne beach, dunes, seagrass shallows, mangrove, nature center, and family facilities. The sheltered water can be calmer than Miami Beach, but seaweed, currents, and weekend traffic remain variable.", hours: { default: "Daily 8:00 AM–sunset; Visitor and Nature Center 9:00 AM–4:00 PM." }, officialUrl: "https://www.miamidade.gov/global/recreation/park/crandon-park.page", subcategory: "barrier_island_park", attributeTags: ["beach", "nature_center", "mangrove", "family_friendly", "cycling"] },
    { id: "miami-nature-virginia-key", name: "Virginia Key North Point", coordinates: [25.744, -80.155], description: "Virginia Key North Point combines restored dune, mangrove shore, beach, and a purpose-built mountain-bike trail network near downtown Miami. Heat, trail closures, insects, and causeway access make it an active outing rather than a casual beach stop.", hours: { default: "Daily: Apr–Oct 7:00 AM–7:00 PM; Nov–Mar 7:00 AM–5:30 PM." }, officialUrl: "https://www.miami.gov/Parks-Public-Places/Parks-Directory/Virginia-Key-Beach-North-Point-Park", subcategory: "coastal_trail_park", attributeTags: ["mountain_biking", "beach", "mangrove", "dunes", "active"] },
    { id: "miami-nature-beach-botanical", name: "Miami Beach Botanical Garden", coordinates: [25.791, -80.135], description: "Miami Beach Botanical Garden compresses palms, orchids, native planting, Japanese garden elements, and water features into a compact public garden beside the Convention Center. It is small, free, and useful for plant detail rather than a long escape.", hours: { monday: "Closed", tuesday: "9:00 AM–5:00 PM", wednesday: "9:00 AM–5:00 PM", thursday: "9:00 AM–5:00 PM", friday: "9:00 AM–5:00 PM", saturday: "9:00 AM–5:00 PM", sunday: "9:00 AM–5:00 PM" }, officialUrl: "https://www.mbgarden.org/", subcategory: "botanical_garden", attributeTags: ["garden", "tropical_plants", "free_entry", "accessible", "compact"] },
    { id: "miami-nature-simpson", name: "Simpson Park Hammock", coordinates: [25.761, -80.195], description: "Simpson Park preserves a rare remnant of tropical hardwood hammock inside Brickell, with dense canopy, limestone, and native species surviving the surrounding towers. Limited gate hours and fragile habitat keep the visit short and focused.", hours: { default: "Daily 8:00 AM–3:00 PM." }, officialUrl: "https://www.miami.gov/Parks-Public-Places/Parks-Directory/Simpson-Rockland-Hammock-Preserve-Park", subcategory: "hardwood_hammock", attributeTags: ["forest", "native_plants", "birdwatching", "central", "free_entry"] },
  ],
}));

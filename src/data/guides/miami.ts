...
const diningStops = [
  ...
  stop({ id: "miami-dining-macchialina", name: "Macchialina", coordinates: [25.785317, -80.141582], description: "Macchialina is the South Beach Italian room to use when you want pasta, wine, and a little neighborhood friction instead of another hotel dining room. The hand-made pasta and compact room make it feel intimate quickly; reserve, especially if the plan depends on a pre-nightlife dinner.", officialUrl: "https://macchialina.com/", photo: images.macchialina, hours: { default: "Dinner hours and weekly specials are posted by day on the official site; use same-week service before going." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "restaurant", cuisineTypes: ["italian", "pasta", "wine"], attributeTags: ["reservation_recommended", "date_night", "wine", "south_beach", "local_favorite"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://www.theinfatuation.com/miami/reviews/macchialina"] }),
  stop({ id: "miami-dining-zak", name: "Zak the Baker", coordinates: [25.801434, -80.201995], description: "Zak the Baker is the Wynwood breakfast and lunch stop that proves Miami food is not only late nights and hotel tabs: sourdough, babka, sandwiches, salads, and a bakery line with real turnover. Go earlier in the day, expect crowds, and use it before galleries rather than after a heavy beach afternoon.", officialUrl: "https://www.zakthebaker.com/", photo: images.zak, hours: { default: "Official bakery hours vary by weekday and weekend service; use official page hours before routing a morning around it." }, price: "$$", priceSource: "Official menu / Google Maps", venueKind: "food_drink", foodServiceType: "bakery", cuisineTypes: ["bakery", "jewish", "breakfast"], attributeTags: ["breakfast", "bakery", "vegetarian_friendly", "walk_in_friendly", "wynwood"], editorialUrls: ["https://miami.eater.com/maps/miami-best-restaurants-38", "https://www.timeout.com/miami/restaurants/zak-the-baker"] }),
...
const cocktailStops = [
  ...
  stop({ id: "miami-cocktail-swizzle", name: "Swizzle Rum Bar & Drinkery", coordinates: [25.781777, -80.132585], description: "Swizzle is the rum-focused South Beach basement for drinkers who want craft without the courtyard glamour. The room is small and moodier than the beach around it, so it works best for a planned cocktail stop rather than a huge group drift-in.", officialUrl: "https://www.swizzlerumbarmiami.com/", photo: images.swizzle, hours: { default: "Evening and late-night hours vary by day; use current schedule before going; official page controls the posted schedule." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", attributeTags: ["craft_cocktails", "speakeasy", "rum", "date_night", "south_beach"], editorialUrls: ["https://www.timeout.com/miami/bars/swizzle-rum-bar-drinkery", "https://www.theinfatuation.com/miami/reviews/swizzle-rum-bar-drinkery"] }),
  ...
  stop({ id: "miami-cocktail-sugar", name: "Sugar", coordinates: [25.767478, -80.193598], description: "Sugar is the Brickell rooftop that earns its slot because the view actually changes the night: skyline, height, and a garden-like room above the mall-and-office grid. It is popular and dress-code aware, so use it for one scenic drink, not an effortless casual hang.", officialUrl: "https://www.sugar-miami.com/", photo: images.sugar, hours: { default: "Evening rooftop hours vary by day, weather, and private events; use before going." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "rooftop_bar", attributeTags: ["scenic_nightlife", "rooftop", "dressy", "brickell", "reservation_recommended_nightlife"], editorialUrls: ["https://www.timeout.com/miami/bars/sugar", "https://miami.eater.com/maps/best-rooftop-bars-miami"] }),
];
...
const cultureStops = [
  ...
  stop({ id: "miami-culture-rubell", name: "Rubell Museum", coordinates: [25.802803, -80.204331], description: "Rubell Museum gives Miami a serious private-collection stop in Allapattah, with large-scale contemporary work and a calmer alternative to the Wynwood churn. It is best for travelers who actually want gallery time, not just murals; check hours because it is not a late-day afterthought.", officialUrl: "https://rubellmuseum.org/miami", photo: images.rubell, hours: { default: "Museum hours and closed days vary seasonally; use the official Miami hours page before visiting." }, venueKind: "culture", subcategory: "museum", attributeTags: ["museum", "contemporary_art", "indoor", "allapattah", "tickets_required"], editorialUrls: ["https://www.miamiandbeaches.com/l/arts-and-culture/rubell-museum/43463", "https://www.timeout.com/miami/museums/rubell-museum"] }),

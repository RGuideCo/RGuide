...
const images = {
  ...
  brokenShaker: "https://images.getbento.com/accounts/f468abc38bf68e2c74a93581297771cf/media/images/instagram.png?w=1000&fit=max&auto=compress",
  sweetLiberty: "https://cdn.prod.website-files.com/65bc68aafffa61a6d8ef5a77/660483bae0636b8ec2fa1029_IMG_7789.jpeg",
  cafeLaTrova: "https://ballandchainmiami.com/wp-content/uploads/2015/02/ballandchain-facebook.jpg",
  swizzle: "https://cdn.prod.website-files.com/65bc68aafffa61a6d8ef5a77/660483bae0636b8ec2fa1029_IMG_7789.jpeg",
  jaguarSun: "https://images.squarespace-cdn.com/content/v1/5b5b5cd3f8370a099b9bc4c0/1625202043352-AG4UD96Z5C5NO3QP1MRI/JS.jpg",
  kaiju: "https://images.squarespace-cdn.com/content/v1/68378a0022476b1092657eb6/1748470272865-PSOFY66YU661N5VQI6F2/01.png",
  mediumCool: "https://images.squarespace-cdn.com/content/v1/68378a0022476b1092657eb6/1748470272865-PSOFY66YU661N5VQI6F2/01.png",
  dantes: "https://images.squarespace-cdn.com/content/v1/68378a0022476b1092657eb6/1748470272865-PSOFY66YU661N5VQI6F2/01.png",
...
const cocktailStops = [
  ...
  stop({ id: "miami-cocktail-jaguar-sun", name: "Jaguar Sun", coordinates: [25.777144, -80.189965], description: "Jaguar Sun is the Downtown cocktail-and-food room that keeps showing up because the drinks, pasta, oysters, and tiny bar energy all punch above the space. It belongs in cocktail rather than dining here because the best use is a reservation, a martini, and a night that can stay compact.", officialUrl: "https://www.jaguarsunmia.com/", photo: images.jaguarSun, hours: { default: "Dinner and bar hours vary by day; verify the official reservation calendar before going." }, price: "$$$", priceSource: "Official menu / Google Maps", venueKind: "nightlife", nightlifeType: "cocktail_bar", attributeTags: ["craft_cocktails", "date_night", "reservation_recommended_nightlife", "downtown", "food_bar"], editorialUrls: ["https://miami.eater.com/maps/best-bars-miami", "https://www.theinfatuation.com/miami/reviews/jaguar-sun"] }),
...
export const miamiCitywideGuides: MapList[] = [
  guide("Food", "list-miami-best-restaurants", "miami-best-restaurants", "best-restaurants", "Stone Crab, Cuban Rooms, Chef Tables, and River Fish", "A citywide Miami dining guide that keeps the beach, Little Havana, Design District, riverfront seafood, and chef-driven rooms in the same conversation without pretending they serve the same trip mood.", diningStops, sources.dining, "Best Restaurants in Miami for Cuban Food, Seafood, and Chef Tables", "Source-backed Miami restaurant guide with stone crab, Cuban classics, seafood, tasting menus, bakeries, and neighborhood dining."),
  guide("Food", "list-miami-cheap-eats", "miami-best-cheap-eats", "best-cheap-eats", "Cuban Sandwiches, Arepas, Tacos, and Fast Miami Meals", "A practical Miami cheap-and-medium eats guide for Cuban counters, sandwich windows, arepas, tacos, burgers, and casual group meals that solve a hot city day without a formal reservation.", cheapEatStops, sources.cheapEats, "Best Cheap Eats in Miami for Cuban Sandwiches, Arepas, Tacos, and Fast Meals", "Budget and medium-price Miami food stops with official evidence, map status, and practical route notes."),
  guide("Stay", "list-miami-hotels", "miami-best-hotels", "best-hotels", "Hotels by Beach, Brickell, Grove, and Trip Mood", "A hotel-only Miami stay guide that separates South Beach luxury, Mid-Beach theater, Brickell logistics, Coconut Grove calm, and Little Havana neighborhood access so the base matches the trip instead of only the room rate.", hotelStops, sources.hotels, "Best Hotels in Miami for Beach, Brickell, Coconut Grove, and Little Havana Bases", "Hotel-only Miami guide with official booking evidence and base strategy for beach, nightlife, business, wellness, and neighborhood stays."),
  guide("Stay", "list-miami-hostels", "miami-best-hostels", "best-hostels", "Hostels and Budget Social Stays by Beach Fit", "A hostel-only Miami guide built honestly around a thin current hostel market: South Beach dorms, private rooms, social budget stays, and hybrid properties where travelers must verify room type before booking.", hostelStops, sources.hostels, "Best Hostels in Miami for Dorms, Private Rooms, and Budget Social Stays", "Hostel-only Miami guide with dorm/private-room evidence, booking links, and current caveats around hybrid budget stays."),
  guide("Nightlife", "list-miami-dive-bars-casual-bars", "miami-best-dive-bars-casual-bars", "best-dive-bars", "Dives, Pub Rooms, Live Music, and Casual Late Bars", "A casual Miami nightlife guide for people who want old bars, live music, patios, beer, DJs, and late rooms without defaulting to clubs, hotel lounges, or bottle-service choreography.", casualBarStops, sources.casualBars, "Best Dive Bars and Casual Bars in Miami", "Miami dive and casual bar guide with South Beach institutions, Wynwood patios, Little Havana music, Downtown late rooms, and local pub energy."),
  guide("Nightlife", "list-miami-cocktail-bars", "miami-best-cocktail-bars", "best-cocktail-bars", "Rum Rooms, Rooftops, Listening Bars, and Cocktail Classics", "A cocktail-only Miami guide that separates award rooms, rum bars, Little Havana cantinero energy, listening bars, rooftops, and expensive hotel glamour so drinks match the night's actual plan.", cocktailStops, sources.cocktails, "Best Cocktail Bars in Miami for Rum, Rooftops, Listening Rooms, and Beach Drinks", "Source-backed Miami cocktail guide with Broken Shaker, Sweet Liberty, Cafe La Trova, Swizzle, Jaguar Sun, rooftops, and hotel glamour."),
  guide("Culture", "list-miami-culture", "miami-best-culture", "best-culture", "Art Deco, Museums, Little Havana, and Design District Culture", "A citywide Miami culture guide that keeps Art Deco, contemporary art, Little Havana, performance, gardens, and bayfront museums together instead of reducing the city to murals and beaches.", cultureStops, sources.culture, "Best Culture in Miami for Museums, Art Deco, Little Havana, and Performance", "Miami culture guide with official evidence for Art Deco, museums, Little Havana, Wynwood, Design District, Vizcaya, and performance venues."),

...
export const capeTownCitywideGuides: MapList[] = [
  ...
  guide(
    ...
    "best-casual-bars",
    "Cape Town Pubs, Taprooms, and Unpolished Bars",
    "A citywide route through historic sports pubs, motorcycle-and-whisky rooms, local breweries, live-music bars, and relaxed suburban institutions where atmosphere matters more than velvet-rope polish.",
    casualBarStops,
    sourcesFor(
      casualBarStops,
      source("Cape Town Tourism bars and clubs", editorial.capeTownBars),
    ),
    "Best Casual Bars and Pubs in Cape Town for Beer, Sport, and Live Music",
    "Source-backed Cape Town bar guide to Fireman's Arms, Forries, Tommy's, House of Machines, Aegir, and neighborhood favourites.",
  ),
  guide(
    "Nightlife",

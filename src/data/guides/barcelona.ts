...
const barcelonaBaseGuides = withDiveBarChips([
  ...barcelonaCoreGuides,
  ...barcelonaItineraryGuides,
] satisfies MapList[]);

const barcelonaCocktailBarStops: GuideStop[] = [
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-dry-martini",
    id: "eixample-dry-martini",
    name: "Dry Martini",
    description: "Dry Martini has anchored Barcelona's classic cocktail culture since 1978. The polished Eixample room still treats the martini as ritual rather than novelty, making it the strongest counterpoint to the city's newer experimental bars.",
    category: "Nightlife",
    venueKind: "nightlife",
    nightlifeType: "cocktail_bar",
    attributeTags: ["classic_cocktails", "martinis", "historic", "reservations"],
    price: "$$$",
    hours: { mon: "1:00 PM-2:30 AM", tue: "1:00 PM-2:30 AM", wed: "1:00 PM-2:30 AM", thu: "1:00 PM-2:30 AM", fri: "1:00 PM-3:00 AM", sat: "1:00 PM-3:00 AM", sun: "4:30 PM-1:00 AM" },
    officialUrl: "https://www.drymartinibarcelona.com/",
    mapQuery: "Dry Martini, Carrer d'Aribau 162-166, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-sips",
    id: "eixample-sips",
    name: "Sips",
    description: "Sips builds each drink as a compact performance, with precise technique, unusual vessels, and a high-energy standing-room format. Demand is heavy, so treat it as a planned destination rather than an effortless first round.",
    category: "Nightlife",
    venueKind: "nightlife",
    nightlifeType: "cocktail_bar",
    attributeTags: ["world_ranked", "experimental", "high_demand", "reservations"],
    price: "$$$",
    hours: { mon: "Closed", tue: "6:30 PM-2:00 AM", wed: "6:30 PM-2:00 AM", thu: "6:30 PM-2:00 AM", fri: "6:30 PM-2:00 AM", sat: "6:30 PM-2:00 AM", sun: "Closed" },
    officialUrl: "https://sips.barcelona/",
    currentStatusUrl: "https://ajuntament.barcelona.cat/lescorts/es/guia-del-districte/equipaments-temes/llistat/cocteleria-sips-drinkery-house-75990421116",
    mapQuery: "Sips Drinkery House, Carrer de Muntaner 108, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-bobbys-free",
    id: "eixample-bobbys-free",
    name: "Bobby's Free",
    description: "Bobby's Free hides its cocktail room behind a barbershop entrance and changes the password through its social channels each month. Once inside, the drinks and live-music programming make it more than a one-note hidden-door gimmick.",
    category: "Nightlife",
    venueKind: "nightlife",
    nightlifeType: "cocktail_bar",
    musicGenres: ["live_music"],
    attributeTags: ["speakeasy", "password", "no_reservations", "live_music"],
    price: "$$$",
    hours: { default: "Daily 7:00 PM-3:00 AM; no reservations, and the monthly entry password is published through the official venue channels." },
    officialUrl: "https://www.bobbysfree.com/en/",
    mapQuery: "Bobby's Free, Carrer de Pau Claris 85, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-the-alchemix",
    id: "eixample-the-alchemix",
    name: "The Alchemix",
    description: "The Alchemix treats cocktails and food as one menu, using tasting formats and pairings instead of separating dinner from drinks. It works best as a reserved, deliberate experience rather than a quick bar on a loose crawl.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "cocktail_bar",
    foodServiceType: "restaurant",
    attributeTags: ["gastro_cocktails", "tasting_menu", "pairings", "reservations"],
    price: "$$$",
    hours: { mon: "7:30 PM-1:30 AM", tue: "7:30 PM-1:30 AM", wed: "7:30 PM-1:30 AM", thu: "7:30 PM-1:30 AM", fri: "7:30 PM-1:30 AM", sat: "7:30 PM-1:30 AM", sun: "Closed" },
    officialUrl: "https://thealchemix.com/en/",
    currentStatusUrl: "https://www.timeout.es/barcelona/es/bares-y-pubs/the-alchemix",
    mapQuery: "The Alchemix, Carrer de Valencia 212, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "born-paradiso",
    id: "born-paradiso",
    name: "Paradiso",
    description: "Paradiso is Barcelona's headline cocktail destination, entered through a pastrami-shop refrigerator door and built around theatrical seasonal menus. It does not take advance reservations; join the official virtual queue and treat the wait as part of the night's planning.",
    category: "Nightlife",
    venueKind: "nightlife",
    nightlifeType: "cocktail_bar",
    attributeTags: ["virtual_queue", "theatrical", "world_ranked", "speakeasy"],
    price: "$$$",
    hours: { mon: "5:00 PM-2:30 AM", tue: "5:00 PM-2:30 AM", wed: "5:00 PM-2:30 AM", thu: "4:30 PM-2:30 AM", fri: "4:30 PM-2:30 AM", sat: "4:30 PM-2:30 AM", sun: "4:30 PM-2:30 AM" },
    officialUrl: "https://paradiso.cat/",
    currentStatusUrl: "https://grupconfiteria.com/en/group/paradiso/",
    editorialUrls: ["https://paradiso.cat/en/contact/"],
    mapQuery: "Paradiso, Carrer de Rera Palau 4, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "born-stravinsky",
    id: "born-stravinsky",
    name: "Dr. Stravinsky",
    description: "Dr. Stravinsky approaches cocktails like a small laboratory, using house distillation, fermentation, and locally rooted ingredients in a compact El Born room. Walk-ins suit flexible evenings, but the narrow space fills quickly after dinner.",
    category: "Nightlife",
    venueKind: "nightlife",
    nightlifeType: "cocktail_bar",
    attributeTags: ["in_house_distillation", "experimental", "walk_ins", "el_born"],
    price: "$$",
    hours: { mon: "5:00 PM-2:00 AM", tue: "5:00 PM-2:00 AM", wed: "5:00 PM-2:00 AM", thu: "5:00 PM-2:00 AM", fri: "5:00 PM-3:00 AM", sat: "5:00 PM-3:00 AM", sun: "5:00 PM-2:00 AM" },
    officialUrl: "https://drstravinsky.com/",
    currentStatusUrl: "https://www.cylex.es/barcelona/dr--stravinsky-12958018.html",
    mapQuery: "Dr. Stravinsky, Carrer dels Mirallers 5, Barcelona",
  }),
];

const barcelonaLateNightFoodStops: GuideStop[] = [
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "born-bormuth-restaurant",
    id: "born-bormuth-restaurant",
    name: "Bormuth",
    description: "Bormuth is a practical El Born late stop for tapas, vermouth, and a full table without formal planning. Its central location and service past midnight make it useful after bars, though weekend queues can outlast the patience of anyone expecting a quiet dinner.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "restaurant",
    cuisineTypes: ["Catalan", "Tapas"],
    attributeTags: ["late_night", "tapas", "walk_in_friendly", "el_born"],
    hours: { mon: "12:30 PM-1:30 AM", tue: "12:30 PM-1:30 AM", wed: "12:30 PM-1:30 AM", thu: "12:30 PM-1:30 AM", fri: "12:30 PM-2:00 AM", sat: "12:30 PM-2:00 AM", sun: "12:30 PM-1:00 AM" },
    officialUrl: "https://www.bormuthbarcelona.com/",
    currentStatusUrl: "https://ajuntament.barcelona.cat/gracia/es/guia-del-distrito/equipamientos-por-temas/listado/restaurant-bormuth-99400566464",
    mapQuery: "Bormuth, Plaça Comercial 1, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "born-casa-delfin-restaurant",
    id: "born-casa-delfin-restaurant",
    name: "Casa Delfín",
    description: "Casa Delfín keeps an uninterrupted kitchen beside Passeig del Born, serving Catalan rice dishes, fish, tapas, and traditional plates until midnight or 1:00 AM. It is one of the more dependable sit-down choices when dinner starts unusually late.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "restaurant",
    cuisineTypes: ["Catalan", "Mediterranean", "Tapas"],
    attributeTags: ["late_night", "uninterrupted_kitchen", "catalan", "el_born"],
    ...
    officialUrl: "https://casadelfinrestaurant.com/en/",
    mapQuery: "Casa Delfin, Passeig del Born 36, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "born-cuines-santa-caterina",
    id: "born-cuines-santa-caterina",
    name: "Cuines Santa Caterina",
    description: "Cuines Santa Caterina is the flexible market-hall answer for groups with mixed appetites, covering Mediterranean and Asian-influenced dishes under one roof. Friday and Saturday service reaches 11:30 PM, so it is a late dinner option rather than an after-midnight kitchen.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "restaurant",
    cuisineTypes: ["Mediterranean", "Asian", "Market food"],
    attributeTags: ["late_dinner", "market", "group_friendly", "mixed_appetites"],
    hours: { mon: "9:00 AM-11:00 PM", tue: "9:00 AM-11:00 PM", wed: "9:00 AM-11:00 PM", thu: "9:00 AM-11:00 PM", fri: "9:00 AM-11:30 PM", sat: "9:00 AM-11:30 PM", sun: "9:00 AM-11:00 PM", default: "The official Grupo Tragaluz reservation calendar controls holiday changes and exceptional closures." },
    officialUrl: "https://grupotragaluz.com/restaurantes/cuines-santa-caterina/",
    currentStatusUrl: "https://mercatsantacaterina.com/ca/parada/restaurant-cuines-de-santa-caterina/",
    mapQuery: "Cuines Santa Caterina, Avinguda de Francesc Cambo 16, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-cerveceria-catalana",
    id: "eixample-cerveceria-catalana",
    name: "Cervecería Catalana",
    description: "Cervecería Catalana is a high-volume Eixample tapas room where broad choice and fast counter turnover matter more than secrecy. It stays useful for a late dinner, but expect a queue and confirm the kitchen cutoff when arriving close to closing.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "restaurant",
    cuisineTypes: ["Catalan", "Tapas"],
    attributeTags: ["late_dinner", "tapas", "high_demand", "eixample"],
    hours: { mon: "12:00 PM-12:00 AM", tue: "12:00 PM-12:00 AM", wed: "12:00 PM-12:00 AM", thu: "12:00 PM-12:00 AM", fri: "12:00 PM-1:00 AM", sat: "12:00 PM-1:00 AM", sun: "12:00 PM-12:00 AM" },
    officialUrl: "https://ajuntament.barcelona.cat/agendajove/en/detall/cerveseria-catalana_75990341849.html",
    currentStatusUrl: "https://maps.apple.com/place?place-id=IA5FD54A56C0C3745",
    mapQuery: "Cerveceria Catalana, Carrer de Mallorca 236, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-bodega-joan-restaurant",
    id: "eixample-bodega-joan-restaurant",
    name: "Bodega Joan",
    description: "Bodega Joan runs from breakfast through 1:00 AM with Catalan tapas, charcuterie, rice dishes, and a straightforward neighborhood dining room. The long official service window makes it a reliable option when a group needs real food after a late arrival.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "restaurant",
    cuisineTypes: ["Catalan", "Tapas", "Rice"],
    attributeTags: ["late_night", "all_day", "group_friendly", "eixample"],
    hours: { default: "Daily 7:00 AM-1:00 AM." },
    officialUrl: "https://www.bodegajoan.com/en/carta",
    mapQuery: "Bodega Joan, Carrer del Rossello 164, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-el-nacional-restaurant",
    id: "eixample-el-nacional-restaurant",
    name: "El Nacional",
    description: "El Nacional solves late group logistics through several food counters and bars inside one grand Passeig de Gràcia hall. The building stays open until midnight or 1:00 AM, but most kitchens stop between 11:00 and 11:30 PM, so arrive before the final hour for a full meal.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "restaurant",
    cuisineTypes: ["Spanish", "Seafood", "Tapas"],
    attributeTags: ["late_dinner", "food_hall", "group_friendly", "mixed_appetites"],
    hours: { mon: "12:00 PM-12:00 AM", tue: "12:00 PM-12:00 AM", wed: "12:00 PM-12:00 AM", thu: "12:00 PM-12:00 AM", fri: "12:00 PM-1:00 AM", sat: "12:00 PM-1:00 AM", sun: "12:00 PM-12:00 AM", default: "Most kitchens close 11:00-11:30 PM; the official hours page lists each counter's cutoff." },
    officialUrl: "https://www.elnacionalbcn.com/horarios/",
    mapQuery: "El Nacional, Passeig de Gracia 24 Bis, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "gracia-bar-canigo-restaurant",
    id: "gracia-bar-canigo-restaurant",
    name: "Bar Canigó",
    description: "Bar Canigó is a century-old Gràcia corner bar for sandwiches, tapas, vermouth, and uncomplicated plates. Thursday through Saturday closing times make it a useful late neighborhood stop, while Monday is daytime-only.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "pub",
    cuisineTypes: ["Catalan", "Tapas", "Sandwiches"],
    attributeTags: ["late_night", "historic", "neighborhood_bar", "gracia"],
    hours: { mon: "10:00 AM-5:00 PM", tue: "10:00 AM-1:00 AM", wed: "10:00 AM-1:00 AM", thu: "10:00 AM-2:00 AM", fri: "10:00 AM-2:30 AM", sat: "7:00 PM-2:30 AM", sun: "Closed" },
    officialUrl: "https://www.barcanigo.com/index_en.html",
    mapQuery: "Bar Canigo, Carrer de Verdi 2, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "gracia-bodega-quimet-restaurant",
    id: "gracia-bodega-quimet-restaurant",
    name: "Bodega Quimet",
    description: "Bodega Quimet is a Gràcia tavern for vermouth, conservas, cheese, anchovies, and a light grazing meal. Dinner ends at 11:00 PM Tuesday through Saturday, so choose it for a late Spanish dinner rather than food after midnight.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "pub",
    cuisineTypes: ["Catalan", "Conservas", "Tapas"],
    attributeTags: ["late_dinner", "vermouth", "conservas", "gracia"],
    hours: { mon: "10:00 AM-4:00 PM", tue: "10:00 AM-4:00 PM; 6:00 PM-11:00 PM", wed: "10:00 AM-4:00 PM; 6:00 PM-11:00 PM", thu: "10:00 AM-4:00 PM; 6:00 PM-11:00 PM", fri: "11:00 AM-4:00 PM; 6:00 PM-11:00 PM", sat: "11:00 AM-4:00 PM; 6:00 PM-11:00 PM", sun: "11:00 AM-4:00 PM" },
    officialUrl: "https://www.bodegaquimet.com/en/localizacion",
    mapQuery: "Bodega Quimet, Carrer de Vic 23, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "gracia-bar-salvatge-restaurant",
    id: "gracia-bar-salvatge-restaurant",
    name: "Bar Salvatge",
    description: "Bar Salvatge pairs natural wine with cheeses and small plates made from fresh local produce. Daily service until 12:30 AM gives Gràcia a food-led wine option later than most specialist bodegas, though it remains a grazing stop rather than a full after-hours restaurant.",
    category: "Food",
    venueKind: "food_drink",
    foodServiceType: "pub",
    cuisineTypes: ["Catalan", "Natural wine", "Small plates"],
    attributeTags: ["late_night", "natural_wine", "small_plates", "gracia"],
...
const barcelonaRooftopStops: GuideStop[] = [
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "gothic-kimpton-vividora",
    id: "barcelona-rooftop-terraza-vivi",
    name: "Terraza de Vivi",
    description: "Terraza de Vivi sits above Kimpton Vividora near the cathedral with cocktails, Mediterranean plates, a poolside setting, and old-city roof views. The public bar closes earlier than Barcelona's late-night rooms, making it better for lunch or sunset than a final drink.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "cocktails", "old_city_views", "daytime"],
    price: "$$$",
    hours: { mon: "12:00 PM-8:00 PM", tue: "12:00 PM-8:00 PM", wed: "12:00 PM-8:00 PM", thu: "12:00 PM-8:00 PM", fri: "12:00 PM-10:00 PM", sat: "12:00 PM-10:00 PM", sun: "12:00 PM-10:00 PM" },
    officialUrl: "https://www.ihg.com/kimptonhotels/hotels/us/en/barcelona/bcnkd/hoteldetail/dining/terrazadevivi",
    mapQuery: "Terraza de Vivi, Carrer del Duc 15, Barcelona",
    photo: "https://digital.ihg.com/is/image/ihg/kimpton-barcelona-10433777785-2x1",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "born-barcelona-edition",
    id: "barcelona-rooftop-the-roof-edition",
    name: "The Roof at The Barcelona EDITION",
    description: "The Roof overlooks Santa Caterina Market from the Barcelona EDITION, combining Latin American-influenced food, cocktails, and a poolside terrace. It is a polished central roof with all-day hours, but the kitchen ends before the bar, so plan dinner earlier than midnight drinks.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "cocktails", "pool", "el_born"],
    price: "$$$",
    hours: { default: "Daily 11:00 AM-12:00 AM; kitchen service ends at 10:30 PM." },
    officialUrl: "https://www.editionhotels.com/barcelona/restaurants-and-bars/the-roof/",
    mapQuery: "The Roof Barcelona EDITION, Avinguda de Francesc Cambo 14, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-almanac",
    id: "barcelona-rooftop-azimuth",
    name: "Azimuth Rooftop Bar",
    description: "Azimuth crowns Almanac Barcelona with cocktails, light Mediterranean food, and a calm terrace close to Passeig de Gràcia. Daily service runs past midnight, giving it more flexibility than seasonal hotel roofs; reserve the best-positioned tables when sunset views matter.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "cocktails", "eixample", "reservations"],
    price: "$$$",
    hours: { default: "Daily 12:30 PM-12:30 AM." },
    officialUrl: "https://www.almanachotels.com/barcelona/food-drinks/azimuth-rooftop-bar/",
    mapQuery: "Azimuth Rooftop Bar, Gran Via de les Corts Catalanes 619, Barcelona",
  }),
  createVenueVariantFromGuideStop({
    sourceGuides: barcelonaBaseGuides,
    sourceStopId: "eixample-the-one",
    id: "barcelona-rooftop-mood",
    name: "Mood Rooftop Bar",
    description: "Mood Rooftop sits on The One Barcelona near La Pedrera, with Mediterranean food, cocktails, and a quieter luxury-hotel setting above Eixample. It opens from noon to midnight, while pool access remains separate from ordinary bar use.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "cocktails", "eixample", "luxury"],
    price: "$$$",
    hours: { default: "Daily 12:00 PM-12:00 AM." },
    officialUrl: "https://www.hotelstheone.com/en/barcelona-hotels/the-one-barcelona/restaurants",
    mapQuery: "Mood Rooftop Bar, Carrer de Provenca 277, Barcelona",
  }),
  createResearchedEditorialStop({
    id: "barcelona-rooftop-pulitzer",
    name: "The Pulitzer Terrace",
    coordinates: [41.3861265, 2.168353],
    description: "The Pulitzer Terrace hides above a hotel just off Plaça de Catalunya, with plants, cocktails, light food, and music programming that feels less exposed than the city's panoramic roofs. Weekend daytime openings suit a slower lunch; weekday service starts in the late afternoon.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    musicGenres: ["dj", "live_music"],
    attributeTags: ["rooftop", "music", "cocktails", "central"],
    price: "$$$",
    hours: { mon: "5:00 PM-10:00 PM", tue: "5:00 PM-10:00 PM", wed: "5:00 PM-10:00 PM", thu: "5:00 PM-10:00 PM", fri: "5:00 PM-10:00 PM", sat: "1:00 PM-10:00 PM", sun: "1:00 PM-10:00 PM" },
    officialUrl: "https://www.hotelpulitzer.es/eat-drink",
    mapQuery: "The Pulitzer Terrace, Carrer de Bergara 8, Barcelona",
    photo: "https://www.hotelpulitzer.com/assets/themes/www.hotelpulitzer.com/img/hero/pulitzer0011.jpg",
  }),
  createResearchedEditorialStop({
    id: "barcelona-rooftop-la-isabela",
    name: "La Isabela at Hotel 1898",
    coordinates: [41.3834822, 2.1712023],
    description: "La Isabela looks across Barcelona's old center from Hotel 1898 with cocktails, tapas, loungers, and a poolside terrace. Summer service runs from noon to midnight with the kitchen ending at 11:00 PM; rain moves service indoors rather than guaranteeing an exposed roof.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "cocktails", "old_city_views", "seasonal"],
    price: "$$$",
    hours: { default: "Daily 12:00 PM-12:00 AM; kitchen service ends at 11:00 PM.", summer: "Full summer terrace service runs from June through the end of September; the official page controls seasonal and rain-policy changes." },
    officialUrl: "https://www.hotel1898.com/es/terraza-la-isabela",
    mapQuery: "La Isabela Hotel 1898, La Rambla 109, Barcelona",
    photo: "https://fishhotels-sites.s3.eu-west-3.amazonaws.com/uploads/6285e0f3-abae-41f9-ab79-080f45f21f09/originals/restaurante-la-isabela-7.jpg",
  }),
  createResearchedEditorialStop({
    id: "barcelona-rooftop-tope",
    name: "Tope at The Hoxton Poblenou",
    coordinates: [41.4036273, 2.1902743],
    description: "Tope brings Mexican tacos, frozen margaritas, and a poolside roof to The Hoxton in Poblenou. It trades old-city monuments for open views and a social hotel crowd; the kitchen closes at 10:00 PM even though the terrace continues for another hour.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "tacos", "margaritas", "poblenou"],
    price: "$$$",
    hours: { default: "Daily 11:00 AM-11:00 PM; kitchen service ends at 10:00 PM." },
    officialUrl: "https://thehoxton.work/poblenou/",
    mapQuery: "Tope at The Hoxton Poblenou, Avinguda Diagonal 205, Barcelona",
    photo: "https://thehoxton.work/wp-content/uploads/sites/5/2020/03/Barcelona-pool-view.jpg?resize=1000,800&quality=70",
  }),
  createResearchedEditorialStop({
    id: "barcelona-rooftop-ohla",
    name: "Rooftop Ohla Barcelona",
    coordinates: [41.3870568, 2.1743356],
    description: "Ohla Barcelona's roof has a glass-sided pool, cathedral-area views, cocktails, and a more intimate footprint than the large panoramic decks. Non-guest hours differ by day, so Friday and Saturday afternoons provide the longest public window.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "pool", "cocktails", "old_city_views"],
    price: "$$$",
    hours: { mon: "3:00 PM-10:00 PM", tue: "3:00 PM-10:00 PM", wed: "3:00 PM-10:00 PM", thu: "3:00 PM-10:00 PM", fri: "1:00 PM-11:00 PM", sat: "1:00 PM-11:00 PM", sun: "3:00 PM-10:00 PM" },
    officialUrl: "https://www.ohlaboutiquehotels.com/en/ohla-barcelona/rooftop/",
    mapQuery: "Rooftop Ohla Barcelona, Via Laietana 49, Barcelona",
    photo: "https://www.ohlaboutiquehotels.com/content/thumbs/2048_/content/imgsxml/panel_bannerA/4-rooftop-be2d6ab8e118d599fb073d3fb2f3ebf9.jpg",
  }),
  createResearchedEditorialStop({
    id: "barcelona-rooftop-grand-central",
    name: "La Terraza del Central",
    coordinates: [41.3848981, 2.1777279],
    description: "La Terraza del Central sits above Grand Hotel Central with an infinity-pool edge and direct views toward the Gothic Quarter. Public terrace service runs from noon to 10:00 PM, with the kitchen opening an hour later; this is a daytime and sunset roof, not a late bar.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "pool", "sunset", "old_city_views"],
    price: "$$$",
    hours: { default: "Daily 12:00 PM-10:00 PM; kitchen service runs 1:00 PM-10:00 PM." },
    officialUrl: "https://www.grandhotelcentral.com/en/rooftop-barcelona/",
    mapQuery: "La Terraza del Central, Via Laietana 30, Barcelona",
    photo: "https://www.grandhotelcentral.com/content/thumbs/1200_/content/imgsxml/imagenes_menu/grand-hotel-central-infinity-pool-rooftop-2510.jpg",
  }),
  createResearchedEditorialStop({
    id: "barcelona-rooftop-barcelo-raval",
    name: "360° Terrace at Barceló Raval",
    coordinates: [41.3789959, 2.1694615],
    description: "Barceló Raval's circular roof gives a true 360-degree look across the old city, Montjuïc, and the port edge. Public terrace access runs through the day and evening, while special sunset events and bar programming follow the hotel's dated experience calendar.",
    category: "Nightlife",
    venueKind: "food_drink",
    nightlifeType: "rooftop_bar",
    attributeTags: ["rooftop", "panoramic_views", "raval", "sunset"],
    price: "$$$",
    hours: { default: "Daily terrace access 12:00 PM-10:00 PM; dated sunset events and bar programming follow the official hotel experience calendar." },
    officialUrl: "https://www.barcelo.com/en-gb/barcelo-raval/",
    mapQuery: "360 Terrace Barcelo Raval, Rambla del Raval 17, Barcelona",
    photo: "https://static.barcelo.com/content/dam/bhg/master/es/hoteles/spain/cataluna/barcelona/barcelo-raval/main-photos/hotel/BRAV_VIEW_020.jpg",
  }),
];

export const barcelonaSeoQueryGuides = [
  createDerivedEditorialGuide({
    id: "list-barcelona-citywide-cocktail-bars",
    slug: "barcelona-best-cocktail-bars-citywide",
    seoSlug: "best-cocktail-bars",
    seoTitle: "Best Cocktail Bars in Barcelona",
    seoDescription: "The best cocktail bars in Barcelona for inventive drinks, classics, gin, whisky, speakeasy rooms, and late-night reservations across Eixample, El Born, and Gracia.",
    title: "Modern Cocktails, Hidden Rooms, and Serious Classics",
    description: "Barcelona's cocktail scene moves between globally recognized modern bars, hidden rooms, old-school martini service, and small neighborhood specialists. These ten choices compare the drink style, atmosphere, and part of town so the night starts with a deliberate bar rather than the nearest generic terrace.",
    category: "Nightlife",
    city: "Barcelona",
    country: "Spain",
    continent: "Europe",
    stopIds: [
      ...
      "gracia-elephanta",
      "gracia-old-fashioned",
      "eixample-dry-martini",
      "eixample-sips",
      "eixample-bobbys-free",
      "eixample-the-alchemix",
      "born-paradiso",
      "born-stravinsky",
    ],
    sourceGuides: barcelonaBaseGuides,
    extraStops: barcelonaCocktailBarStops,
  }),
  createDerivedEditorialGuide({
    id: "list-barcelona-citywide-late-night-food",
    slug: "barcelona-best-late-night-food-citywide",
    seoSlug: "best-late-night-food",
    seoTitle: "Best Late-Night Food in Barcelona",
    seoDescription: "The best late-night food in Barcelona, with tapas, Catalan plates, burgers, market dining, and kitchens serving around or after midnight across the old city, Eixample, and Gracia.",
    title: "Midnight Tapas, Long Kitchens, and After-Drinks Plates",
    description: "Barcelona eats late, but a bar's closing time is not the same as its kitchen time. These ten restaurants and food-led bars publish service around or after midnight on at least part of the week, covering central groups, Catalan standards, casual counters, and reliable post-drinks meals.",
    category: "Food",
    city: "Barcelona",
    country: "Spain",
    continent: "Europe",
    stopIds: [
      "gothic-sensi-bistro",
      "born-bormuth-restaurant",
      "born-casa-delfin-restaurant",
      "born-cuines-santa-caterina",
      "eixample-cerveceria-catalana",
      "eixample-bodega-joan-restaurant",
      "eixample-el-nacional-restaurant",
      "gracia-bar-canigo-restaurant",
      "gracia-bodega-quimet-restaurant",
      "gracia-bar-salvatge-restaurant",
    ],
    sourceGuides: barcelonaBaseGuides,
    extraStops: barcelonaLateNightFoodStops,
  }),
  createDerivedEditorialGuide({
    id: "list-barcelona-citywide-rooftop-bars",
    slug: "barcelona-best-rooftop-bars-citywide",
    seoSlug: "best-rooftop-bars",
    seoTitle: "Best Rooftop Bars in Barcelona",
    seoDescription: "The best rooftop bars in Barcelona for Gothic Quarter views, Eixample cocktails, Poblenou tacos, pools, sunset terraces, music, and panoramic city roofs.",
    title: "Old-City Roofs, Poolside Drinks, and Sunset Tables",
    description: "Barcelona rooftop bars range from compact cathedral-view terraces to poolside hotel decks and broad panoramic roofs. These ten picks clarify public access, kitchen cutoffs, seasonal hours, and whether the experience is built for lunch, sunset, music, or a later cocktail.",
    category: "Nightlife",
    city: "Barcelona",
    country: "Spain",
    continent: "Europe",
    stopIds: [
      "barcelona-rooftop-terraza-vivi",
      "barcelona-rooftop-the-roof-edition",
      "barcelona-rooftop-azimuth",
      "barcelona-rooftop-mood",
      "barcelona-rooftop-pulitzer",
      "barcelona-rooftop-la-isabela",
      "barcelona-rooftop-tope",
      "barcelona-rooftop-ohla",
      "barcelona-rooftop-grand-central",
      "barcelona-rooftop-barcelo-raval",
    ],
    sourceGuides: barcelonaBaseGuides,
    extraStops: barcelonaRooftopStops,
  }),
];

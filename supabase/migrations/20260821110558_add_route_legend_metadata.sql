-- Expose optional guide route legends through normalized MapList payloads.
begin;
...
select
  ...
  jsonb_build_object(
    ...
    'routeCoordinates', entry.metadata->'routeCoordinates',
    'routeLegend', entry.metadata->'routeLegend',
...
select
  ...
  now(),null,true,jsonb_build_object('refreshed_from','entry_route_legend_metadata_20260821')
from public.entries entry

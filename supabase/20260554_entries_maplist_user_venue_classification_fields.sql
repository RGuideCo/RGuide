-- Keep the MapList compatibility payload aligned with normalized venue
-- classification fields used by user-created guides and place search.
...
select
  ...
  null,
  true,
  jsonb_build_object('refreshed_from', 'entries_maplist_user_venue_classification_fields')
from public.entries entry
